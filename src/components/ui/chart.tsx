...
function ChartTooltipContent({
  ...
  active?: boolean;
  // Recharts injects payload/label when rendering tooltip content
  payload?: Array<
  ...
  return (
    <div
      className={cn(
        'border-border/50 bg-background gap-1.5 rounded-lg border px-2.5 py-1.5 text-sm shadow-xl grid min-w-32 items-start',
        className,
      )}
    >
