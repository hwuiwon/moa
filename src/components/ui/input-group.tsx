...
const inputGroupAddonVariants = cva(
  "text-muted-foreground h-auto gap-2 py-1.5 text-base font-medium group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4 flex cursor-text items-center justify-center select-none",
  {
    defaultVariants: {
      align: 'inline-start',
    },
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: Direct from shadcn
    // biome-ignore lint/a11y/useSemanticElements: Direct from shadcn
    <div
