...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      className={cn(
        'hover:bg-muted aria-expanded:bg-muted rounded-sm px-1.5 py-[2px] text-base font-medium flex items-center outline-hidden select-none',
        className,
      )}
...
function MenubarRadioItem({
  ...
  return (
    <MenuPrimitive.RadioItem
      className={cn(
        "focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground gap-1.5 rounded-md py-1 pr-1.5 pl-7 text-base data-disabled:opacity-50 data-inset:pl-7 [&_svg:not([class*='size-'])]:size-4 relative flex cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      data-inset={inset}
...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      className={cn(
        "focus:bg-accent focus:text-accent-foreground data-open:bg-accent data-open:text-accent-foreground gap-1.5 rounded-md px-1.5 py-1 text-base data-inset:pl-7 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      data-inset={inset}
