# concurrent_workspace_writes_to_same_subgraph

## What it tests

This scenario alternates two recorded sessions in the same eval workspace. It verifies that both complete and that the transcript preserves the reconciliation invariants expected from concurrent graph-memory writes.
