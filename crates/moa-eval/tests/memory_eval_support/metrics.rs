...
fn retrieval_metric_probe_results() -> Vec<ProbeResult> {
    vec![
        ...
        ProbeResult {
            ...
            forbidden_fact_absent_at_4: None,
            stored_pii_redacted: None,
            retrieval_temporal_as_of_correct: Some(false),
        ...
        ProbeResult {
            ...
            retrieval_latency_ms: 0,
            all_expected_found_at_4: None,
            forbidden_fact_absent_at_4: Some(false),
            stored_pii_redacted: None,
            retrieval_temporal_as_of_correct: None,
            temporal_filter_parsed: None,
            temporal_filter_matches_as_of: None,
...
fn parse_metric_probe(
    ...
    ProbeResult {
        ...
        forbidden_fact_absent_at_4: None,
        stored_pii_redacted: None,
        retrieval_temporal_as_of_correct: (probe_type == ProbeType::TemporalAsOf).then_some(true),
