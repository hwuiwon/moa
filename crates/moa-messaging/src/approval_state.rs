//! Approval request lifecycle tracking for messaging button interactions.
...
/// Current messaging-visible approval lifecycle state.
...
/// In-memory approval state machine used by messaging adapters.
