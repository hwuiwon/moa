...
use moa_core::{
    ...
    types::completion::{CompletionRequest, CompletionResponse, JsonResponseFormat},
...
use moa_experiments::simulator_policy::{
    runtime::{SimulatorDecision, parse_simulator_response, simulator_response_schema},
...
#[cfg(test)]
pub(crate) fn fixture_simulator_policy(
    model: &str,
) -> moa_experiments::simulator_policy::registry::ResolvedSimulatorPolicy {
    use chrono::Duration;
