...
file for every version from `V000001` through the current maximum. Filenames
...
selected retained SQL as focused, schema-isolated test fragments. They do not
create or update refinery history and are not full-database setup paths.
