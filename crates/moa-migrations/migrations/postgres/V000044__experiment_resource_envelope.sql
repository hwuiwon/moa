...
ALTER TABLE moa.experiment_run
    ADD COLUMN resource_envelope JSONB NOT NULL,
...
ALTER FUNCTION moa.experiment_admission_counts(TEXT, UUID) OWNER TO moa_owner;
REVOKE ALL ON FUNCTION moa.experiment_admission_counts(TEXT, UUID) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION moa.experiment_admission_counts(TEXT, UUID) TO moa_app, moa_promoter;
