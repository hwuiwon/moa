...
ALTER TABLE sessions
    ...
    ADD COLUMN IF NOT EXISTS contact_tenant_id UUID,
    ADD COLUMN IF NOT EXISTS contact_state TEXT,
    ADD COLUMN IF NOT EXISTS contact_canonical_id UUID,
    ADD COLUMN IF NOT EXISTS contact_linked_ids UUID[] NOT NULL DEFAULT '{}',
    ADD COLUMN IF NOT EXISTS contact_scopes TEXT[] NOT NULL DEFAULT '{}',
