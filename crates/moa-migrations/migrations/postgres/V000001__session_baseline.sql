...
-- Source: V000018__session_skills.sql
...
-- Source: V000019__session_skill_addendum.sql
...
-- Source: V000031__session_skill_packages.sql
...
CREATE INDEX IF NOT EXISTS skill_previous_skill_uid_idx
    ON moa.skill(previous_skill_uid)
    WHERE previous_skill_uid IS NOT NULL;
