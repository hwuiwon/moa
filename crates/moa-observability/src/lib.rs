...
pub use runtime_metrics::{
    ...
    record_experiment_trial, record_experiment_trial_duration,
    record_genai_client_operation_duration, record_genai_client_time_to_first_chunk,
    record_genai_client_token_usage, record_knowledge_chunks, record_knowledge_embeddings,
    record_knowledge_graph_write, record_knowledge_ingestion_step_duration,
    record_knowledge_parse_job, record_knowledge_records, record_knowledge_retrieval_duration,
    record_knowledge_retrieval_hits, record_knowledge_sync_run, record_llm_cost_cents,
    record_memory_operation, record_pipeline_compile_duration_metric,
    ...
    record_sessions_active, record_simulation_cost_cents, record_simulation_tokens,
    record_simulation_turn, record_tool_call, record_tool_failure, record_tool_idempotency_scan,
