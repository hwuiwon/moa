...
//! `MOA_AUTH_AUTH0_DOMAIN`, `MOA_AUTH_AUTH0_CLIENT_ID`, `MOA_AUTH_AUTH0_CLIENT_SECRET`,
...
async fn live_auth0_token_vault_returns_third_party_token() {
    ...
    let client_id = required_env("MOA_AUTH_AUTH0_CLIENT_ID");
    let client_secret = required_env("MOA_AUTH_AUTH0_CLIENT_SECRET");
