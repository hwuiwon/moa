...
use crate::{Error, Result, VectorStore, embedding_row::EmbeddingRow};
...
///
/// Pure comparison over two ranked uid lists used by backend promotion
/// validation. It has no state, serving behavior, or backend selection.
