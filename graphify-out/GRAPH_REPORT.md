...
## Corpus Check
- Large corpus: 235 files · ~180,559 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 3310 nodes · 5565 edges · 126 communities detected
...
6. `LocalOrchestrator` - 26 edges
7. `start_session()` - 25 edges
8. `FileMemoryStore` - 22 edges
9. `SessionDatabase` - 21 edges
10. `session()` - 21 edges
...
Cohesion: 0.02
Nodes (61): ServiceBridge, ServiceBridgeHandle, ServiceStatus, group_by_type(), hash_path(), MemoryList, MemoryPageSelected, type_badge() (+53 more)
...
Cohesion: 0.05
Nodes (51): approval_requested_event_persists_full_prompt_details(), collect_runtime_events_until(), completed_tool_turn_destroys_cached_hand(), CurrentDirGuard, cwd_lock(), denied_tool_preserves_queued_follow_up(), DestroyTrackingHandProvider, FileWriteApprovalProvider (+43 more)
...
Cohesion: 0.04
Nodes (33): budget_config_defaults_are_applied(), BudgetConfig, CloudConfig, CloudFlyioConfig, CloudHandsConfig, CloudTemporalConfig, compaction_config_defaults_are_applied(), CompactionConfig (+25 more)

### Community 8 - "Local Orchestrator"
Cohesion: 0.06
Nodes (24): accept_user_message(), append_event(), best_effort_resolve_pending_signal(), detect_docker(), detect_workspace_path(), docker_status(), DockerSandbox, flush_next_queued_message() (+16 more)
...
### Community 18 - "Temporal Orchestrator"
Cohesion: 0.06
...
### Community 19 - "Daytona Workspace Provider"
Cohesion: 0.07
Nodes (27): BashToolInput, execute_docker(), execute_local(), batcher_holds_events_until_interval_elapses(), flush_returns_remaining_events(), StreamBatcher, build_url(), DaytonaHandProvider (+19 more)
...
### Community 35 - "Eval Execution Engine"
Cohesion: 0.12
...
### Community 49 - "Docker File Operations"
Cohesion: 0.11
...
### Community 50 - "Session State Store"
Cohesion: 0.09
...
### Community 52 - "Session Database Interface"
Cohesion: 0.09
Nodes (3): create_session_store(), SessionDatabase, SessionStoreDispatch

### Community 53 - "Session Blob Store"
Cohesion: 0.18
...
### Community 54 - "CLI HTTP API Server"
Cohesion: 0.11
...
### Community 57 - "Completion API Types"
Cohesion: 0.13
...
### Community 58 - "Event Stream Types"
Cohesion: 0.12
...
### Community 60 - "Chat Message Bubbles"
Cohesion: 0.18
...
### Community 62 - "Memory Maintenance Tests"
Cohesion: 0.27
...
### Community 63 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 64 - "Daytona Memory Store Tests"
Cohesion: 0.18
...
### Community 65 - "Settings Panel"
Cohesion: 0.19
Nodes (3): SettingsDismissed, SettingsPage, SettingsSection

### Community 66 - "Memory Bootstrap"
Cohesion: 0.24
...
### Community 68 - "Tool Router Construction"
Cohesion: 0.18
Nodes (2): default_cloud_provider(), ToolRouter

### Community 69 - "Session Row Badges"
Cohesion: 0.2
...
### Community 70 - "Provider Retry Policy"
Cohesion: 0.27
...
### Community 78 - "Postgres Store Tests"
Cohesion: 0.36
...
### Community 79 - "Session Sidebar"
Cohesion: 0.24
Nodes (1): SessionSidebar

### Community 80 - "Neon Branch Manager Tests"
Cohesion: 0.5
...
### Community 81 - "Temporal Worker Helper"
Cohesion: 0.32
...
### Community 84 - "WCAG Contrast Helpers"
Cohesion: 0.39
...
### Community 99 - "Gemini Live Tests"
Cohesion: 0.83
...
### Community 100 - "Chat Harness Example"
Cohesion: 0.83
Nodes (3): main(), resolve_session_db_path(), run_prompt()

### Community 101 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 102 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 103 - "Settings Integration Tests"
Cohesion: 0.83
Nodes (3): removing_from_auto_approve_persists(), scratch_dir(), settings_mutations_round_trip_through_config_file()

### Community 104 - "Desktop Title Bar"
Cohesion: 0.67
Nodes (1): MoaTitleBar

### Community 105 - "General Settings Tab"
Cohesion: 0.67
Nodes (2): render_general_tab(), render_model_card()

### Community 106 - "Error Banner Component"
Cohesion: 0.67
Nodes (2): error_banner(), error_banner_any()

### Community 107 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 108 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 109 - "Sidebar Tab Enum"
Cohesion: 0.67
Nodes (1): SidebarTab

### Community 110 - "Permissions Settings Tab"
Cohesion: 1.0
Nodes (2): render_permissions_tab(), tool_list_card()

### Community 111 - "Desktop Service Init"
Cohesion: 0.67
Nodes (1): InitializedServices

### Community 112 - "Turso Schema Migration"
Cohesion: 1.0
Nodes (0): 

### Community 113 - "Provider HTTP Client"
Cohesion: 1.0
Nodes (0): 

### Community 114 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 115 - "Brain Live Harness Test"
Cohesion: 1.0
Nodes (0): 

### Community 116 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 117 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 118 - "Keyboard Shortcuts Tab"
Cohesion: 1.0
Nodes (0): 

### Community 119 - "Icon Button"
Cohesion: 1.0
Nodes (0): 

### Community 120 - "Section Card"
Cohesion: 1.0
Nodes (0): 

### Community 121 - "Segmented Control"
Cohesion: 1.0
Nodes (0): 

### Community 122 - "Settings Row"
Cohesion: 1.0
Nodes (0): 

### Community 123 - "Markdown Style"
Cohesion: 1.0
Nodes (0): 

### Community 124 - "Nav Item"
Cohesion: 1.0
Nodes (0): 

### Community 125 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 
