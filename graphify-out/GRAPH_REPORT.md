...
## Corpus Check
- Corpus is ~37,057 words - fits in a single context window. You may not need a graph.

## Summary
- 757 nodes · 1101 edges · 46 communities detected
...
3. `TursoSessionStore` - 16 edges
4. `LocalHandProvider` - 16 edges
5. `ChatRuntime` - 12 edges
6. `ToolRouter` - 12 edges
7. `WorkingContext` - 10 edges
8. `DiffViewState` - 9 edges
9. `AnthropicProvider` - 9 edges
10. `AnthropicStreamState` - 9 edges
...
Cohesion: 0.02
Nodes (68): ActionButton, ApprovalDecision, ApprovalRequest, ApprovalRule, Attachment, BrainId, ButtonStyle, ChannelRef (+60 more)
...
### Community 2 - "Turso Session Store"
Cohesion: 0.08
...
### Community 3 - "Runner & Exec Loop"
Cohesion: 0.09
Nodes (23): exec_mode_formats_tool_updates_compactly(), format_tool_update(), resolve_exec_approval(), run_exec(), always_allow_pattern(), approval_fields_for_call(), ApprovalField, ApprovalFileDiff (+15 more)
...
### Community 5 - "Tool Registry & Router"
Cohesion: 0.09
...
### Community 8 - "Context Pipeline Core"
Cohesion: 0.1
...
### Community 10 - "Config & Error Types"
Cohesion: 0.08
...
### Community 11 - "Local Hand Provider"
Cohesion: 0.12
...
### Community 17 - "Approval Card Widget"
Cohesion: 0.27
...
### Community 45 - "Relevant Memory Page"
Cohesion: 1.0
Nodes (1): RelevantMemoryPage

## Knowledge Gaps
- **126 isolated node(s):** `FileMemoryStore Integration Tests`, `sample_page helper`, `create_read_update_and_delete_wiki_pages test`, `fts_search_finds_ranked_results test`, `rebuild_search_index_from_files_restores_results test` (+121 more)
...
- **Should `Turso Session Store` be split into smaller, more focused modules?**
  _Cohesion score 0.08 - nodes in this community are weakly interconnected._
- **Should `Runner & Exec Loop` be split into smaller, more focused modules?**
