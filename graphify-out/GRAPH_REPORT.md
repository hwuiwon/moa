...
## Corpus Check
- Large corpus: 635 files · ~362,306 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6962 nodes · 11276 edges · 227 communities detected
...
Cohesion: 0.01
Nodes (221): PreparedTurnRequest, build_default_pipeline(), build_default_pipeline_with_tools(), GraphMemoryPipelineOptions, CompiledRequest, TurnUsage, DatabaseConfig, DatabaseNeonConfig (+213 more)

### Community 1 - "PII Redaction Core"
Cohesion: 0.01
Nodes (124): ChangelogRecord, validate_scope(), write_and_bump(), acknowledgement(), command_action(), control_action_for_inbound(), GatewayControlAction, IngestCtx (+116 more)

### Community 2 - "Postgres RLS & Audit Tests"
Cohesion: 0.02
Nodes (133): anthropic_offline_429_response_triggers_retry_with_backoff(), anthropic_offline_500_response_triggers_retry_then_surfaces_typed_error(), anthropic_offline_completion_returns_text_for_minimal_request(), anthropic_offline_malformed_json_response_returns_typed_parse_error(), anthropic_offline_streaming_disconnect_mid_response_surfaces_typed_error_with_partial_events(), anthropic_offline_streaming_yields_text_deltas_then_terminal_event(), anthropic_offline_tool_call_response_parses_into_provider_event(), provider() (+125 more)

### Community 3 - "CLI Command Tests"
Cohesion: 0.02
Nodes (83): collect_session_tool_observations(), merge_session_observation(), normalize_error_pattern(), record_error_pattern(), SessionToolObservation, top_error_patterns(), truncate_with_ellipsis(), workspace_tool_stats_from_events() (+75 more)

### Community 4 - "Local Orchestrator Tests"
Cohesion: 0.02
Nodes (38): hand_id(), sandbox_tier_label(), session_provider_key(), ToolRouter, collect_runtime_events_until(), create_test_store(), CurrentDirGuard, cwd_lock() (+30 more)

### Community 5 - "CLI Entry Points"
Cohesion: 0.02
Nodes (107): AdminCommand, format_promotion_report(), handle_admin_command(), promote_workspace_e2e(), PromoteWorkspaceArgs, WorkspacePromotionArgs, BaseModel, CacheCommand (+99 more)
...
### Community 7 - "Eval Fixtures & Pricing"
Cohesion: 0.03
Nodes (61): CollectedExecution, collector_tracks_tool_steps_and_metrics(), estimate_cost(), TrajectoryCollector, truncate(), fixture_path(), transcript_jsonl_round_trips_through_read_and_write(), budgets_evaluate_reports_each_violation_with_metric_name_and_actual_value() (+53 more)

### Community 8 - "Local Chat Runtime"
Cohesion: 0.02
...
Cohesion: 0.03
Nodes (58): daemon_info(), decode_stream_chunk(), expect_success(), expect_success_json(), extract_exit_code(), http_error(), parse_e2b_connect_stream(), request() (+50 more)

### Community 10 - "Tool Types & Policy"
Cohesion: 0.03
...
### Community 11 - "Audit Errors & Merkle Chain"
Cohesion: 0.03
Nodes (62): canonical_json_bytes(), canonical_payload_hash(), chain_detects_tampered_payload(), HashChain, next_chain_hash(), cost_cents_for_anthropic_sonnet_matches_pricing_table_v1_for_known_token_counts(), cost_cents_for_gemini_pro_matches_pricing_table_v1_for_known_token_counts(), cost_cents_for_openai_gpt41_matches_pricing_table_v1_for_known_token_counts() (+54 more)
...
### Community 15 - "Memory Scope Tool"
Cohesion: 0.03
...
### Community 16 - "Orchestrator Test Harness"
Cohesion: 0.05
Nodes (52): approval_allow_once_round_trip_through_restate(), configured_env(), live_model(), object_url(), register_deployment(), spawn_orchestrator(), wait_for_approval_request(), wait_for_brain_response_count() (+44 more)
...
### Community 18 - "Core Event Type"
Cohesion: 0.04
Nodes (41): approval_requested_event_round_trips_full_prompt(), Event, sample_approval_prompt(), add_session_trace_link(), apply_session_trace(), CacheReport, fingerprint_json(), full_request_fingerprint() (+33 more)

### Community 19 - "Fast Ingestion Path"
Cohesion: 0.05
...
### Community 20 - "Eval Engine & Plan"
Cohesion: 0.05
Nodes (51): build_error_result(), cleanup_workspace(), dry_run_marks_results_skipped(), EngineOptions, EvalEngine, EvalRun, extract_trace_id(), fs_try_exists() (+43 more)
...
### Community 23 - "Fact Extraction & Chunking"
Cohesion: 0.05
Nodes (53): ApiState, build_api_router(), health_endpoint_returns_ok(), runtime_event_stream(), session_stream(), session_stream_emits_gap_event_when_runtime_subscriber_lags(), session_stream_returns_not_found_when_runtime_is_unavailable(), session_stream_returns_sse_content_type() (+45 more)
...
### Community 31 - "Cross-Tenant Pentest Suite"
Cohesion: 0.07
...
### Community 32 - "Eval Budget Checker"
Cohesion: 0.06
...
### Community 34 - "Concurrent Event Monotonicity Tests"
Cohesion: 0.08
...
### Community 36 - "Skill Tier1 Metadata"
Cohesion: 0.06
...
### Community 37 - "Golden E2E Fixtures"
Cohesion: 0.07
...
### Community 38 - "Turn Runner Helpers"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (31): append_tool_call_event(), append_tool_error_event(), append_tool_result_event(), build_tool_run_plan(), build_tool_run_plan_uses_max_attempts_one_for_idempotent_tools(), CountingTool, has_prior_non_idempotent_result(), has_prior_tool_call_event() (+23 more)
...
### Community 50 - "Agent Adapter"
Cohesion: 0.06
Nodes (3): AgentAdapter, SessionTurnAdapter, SubAgentTurnAdapter

### Community 51 - "Object State Management"
Cohesion: 0.08
...
### Community 52 - "Long Conversation Smoke Tests"
Cohesion: 0.08
...
### Community 54 - "Approval Always-Allow Tests"
Cohesion: 0.15
...
### Community 55 - "Gateway Message Renderer"
Cohesion: 0.09
...
### Community 57 - "Provider Request Builder"
Cohesion: 0.09
...
### Community 59 - "Session Types"
Cohesion: 0.06
Nodes (29): BufferedUserMessage, CancelMode, CheckpointHandle, CheckpointInfo, DaemonConfig, ObserveLevel, pending_signal_queue_message_round_trip(), PendingSignal (+21 more)

### Community 60 - "Skill Regression Runner"
Cohesion: 0.09
...
### Community 61 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 62 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 63 - "Tool Router Policy"
Cohesion: 0.07
...
### Community 64 - "Completion Content Types"
Cohesion: 0.07
...
### Community 67 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 68 - "Citation Vendor Adapters"
Cohesion: 0.12
...
### Community 70 - "Ingestion E2E Tests"
Cohesion: 0.14
...
### Community 71 - "Session Event Store"
Cohesion: 0.07
Nodes (1): PostgresSessionStore

### Community 72 - "LLM Span Instrumentation"
Cohesion: 0.12
...
### Community 73 - "Intent Manager Service"
Cohesion: 0.09
...
### Community 74 - "Live Cache Audit Tests"
Cohesion: 0.13
...
### Community 75 - "Long Conversation Score Card"
Cohesion: 0.14
...
### Community 78 - "Audit Signing Keys"
Cohesion: 0.13
...
### Community 79 - "Encrypted Secret Vault"
Cohesion: 0.14
...
### Community 80 - "Live Observability Tests"
Cohesion: 0.11
...
### Community 81 - "Local Tools Integration Tests"
Cohesion: 0.13
...
### Community 83 - "Citation Verifiers"
Cohesion: 0.13
...
### Community 85 - "Query Rewrite Postprocess"
Cohesion: 0.11
...
### Community 86 - "Orchestrator Contract Harness"
Cohesion: 0.17
...
### Community 87 - "Session Blob Store"
Cohesion: 0.18
...
### Community 88 - "Task Segment Tracker"
Cohesion: 0.12
...
### Community 89 - "Local Hand Provider"
Cohesion: 0.16
Nodes (3): detect_docker(), docker_status(), LocalHandProvider

### Community 90 - "File Search Tool"
Cohesion: 0.13
...
### Community 91 - "Vector Store Backend"
Cohesion: 0.13
Nodes (12): build_backend(), build_daemon_target(), build_local_target(), DaemonTarget, hipaa_tier_requires_baa_enabled_turbopuffer_client(), LocalTarget, pg_store(), resolve_backend_choice() (+4 more)

### Community 92 - "E2B Hand Provider"
Cohesion: 0.16
Nodes (1): E2BHandProvider

### Community 93 - "Model Capabilities"
Cohesion: 0.1
Nodes (6): Credential, ModelCapabilities, ModelCapabilitiesBuilder, ProviderNativeTool, TokenPricing, ToolCallFormat

### Community 94 - "Local Orchestrator Wiring"
Cohesion: 0.15
Nodes (1): LocalOrchestrator

### Community 95 - "Cache Control Markers Test"
Cohesion: 0.2
...
### Community 97 - "Scripted Provider"
Cohesion: 0.14
Nodes (3): ScriptedBlock, ScriptedProvider, ScriptedResponse

### Community 98 - "Conversation Compaction"
Cohesion: 0.15
...
### Community 99 - "OpenAI Privacy Filter"
Cohesion: 0.14
...
### Community 100 - "Postgres Session Store"
Cohesion: 0.19
Nodes (1): PostgresSessionStore

### Community 101 - "Session Store Handlers"
Cohesion: 0.1
Nodes (1): SessionStoreImpl

### Community 102 - "Grep Tool"
Cohesion: 0.17
...
### Community 103 - "Tool Router Construction"
Cohesion: 0.13
Nodes (2): default_cloud_provider(), ToolRouter

### Community 104 - "Approval Token Auth"
Cohesion: 0.15
...
### Community 105 - "Session Store Inner Impl"
Cohesion: 0.11
Nodes (1): SessionStoreImpl

### Community 106 - "Concurrent Graph Writers Test"
Cohesion: 0.34
...
### Community 107 - "Skills CLI Command"
Cohesion: 0.21
...
### Community 111 - "Brain Steps 72-77 Integration"
Cohesion: 0.19
...
### Community 116 - "Tool Output Budget"
Cohesion: 0.24
...
### Community 117 - "Mock Smoke Loadtest"
Cohesion: 0.2
...
### Community 118 - "Eval Replay Runner"
Cohesion: 0.21
...
### Community 123 - "Gateway Edit Window"
Cohesion: 0.25
...
### Community 126 - "Resolution Scorer"
Cohesion: 0.25
...
### Community 127 - "Verification Signal"
Cohesion: 0.19
...
### Community 130 - "Prometheus Metrics Tests"
Cohesion: 0.23
...
### Community 131 - "OpenAI Responses Envelope Tests"
Cohesion: 0.35
...
### Community 132 - "Gemini Provider"
Cohesion: 0.26
Nodes (1): GeminiProvider

### Community 133 - "Query Planner Tests"
Cohesion: 0.15
Nodes (1): SeedGraph

### Community 134 - "Long Conversation Budgets"
Cohesion: 0.23
...
### Community 137 - "Privacy Erase Command"
Cohesion: 0.29
...
### Community 138 - "Anthropic Provider"
Cohesion: 0.26
Nodes (1): AnthropicProvider

### Community 139 - "Segment Scoring"
Cohesion: 0.38
...
### Community 145 - "DSAR Audit Export Tests"
Cohesion: 0.45
...
### Community 149 - "Intent Classifier"
Cohesion: 0.33
...
### Community 151 - "Live Provider Roundtrip"
Cohesion: 0.38
...
### Community 152 - "Gemini Safety Settings Tests"
Cohesion: 0.47
...
### Community 153 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 166 - "Session Object Handlers"
Cohesion: 0.29
Nodes (1): SessionImpl
...
### Community 176 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 177 - "Pgaudit Smoke Tests"
Cohesion: 0.6
...
### Community 178 - "OpenAI Streaming Tests"
Cohesion: 0.33
Nodes (0): 
...
### Community 189 - "Cohere Live Test"
Cohesion: 0.83
Nodes (3): cohere_embed_v4_returns_1024_dimensional_float_embeddings(), live_cohere_key(), live_cohere_requested()

### Community 190 - "Turbopuffer Live Tests"
Cohesion: 0.83
Nodes (3): basis_vector(), live_store(), turbopuffer_live_round_trip()

### Community 191 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn

### Community 192 - "Approval Rule Store"
Cohesion: 0.5
Nodes (1): PostgresSessionStore

### Community 193 - "Cohere Reranker Live Test"
Cohesion: 0.83
Nodes (3): cohere_rerank_v4_fast_prioritizes_relevant_retrieval_candidate(), live_cohere_key(), live_cohere_requested()

### Community 194 - "History Compaction Compile"
Cohesion: 0.83
Nodes (1): HistoryCompiler

### Community 195 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 196 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 197 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 198 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 199 - "Permissions Config"
Cohesion: 0.67
Nodes (1): PermissionsConfig

### Community 200 - "Gateway Config"
Cohesion: 0.67
Nodes (1): GatewayConfig

### Community 201 - "Session Store Helpers"
Cohesion: 0.67
Nodes (1): PostgresSessionStore

### Community 202 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 203 - "Vector Error Mapping"
Cohesion: 1.0
Nodes (1): moa_core::MoaError

### Community 204 - "Cold Tier Partition Tests"
Cohesion: 1.0
Nodes (0): 

### Community 205 - "Memory Scope Test"
Cohesion: 1.0
Nodes (0): 

### Community 206 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 207 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 208 - "Session Task Runner"
Cohesion: 1.0
Nodes (0): 

### Community 209 - "Shell Chaining Security Test"
Cohesion: 1.0
Nodes (0): 

### Community 210 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0): 

### Community 211 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 212 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 213 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 214 - "History Budgeting"
Cohesion: 1.0
Nodes (0): 

### Community 215 - "History Error Preservation"
Cohesion: 1.0
Nodes (0): 

### Community 216 - "Skills Cache Break"
Cohesion: 1.0
Nodes (0): 

### Community 217 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 218 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 219 - "Workspace Hack Build"
Cohesion: 1.0
Nodes (0): 

### Community 220 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 221 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 222 - "Brain Orchestrator Stub"
Cohesion: 1.0
Nodes (0): 

### Community 223 - "Local Orchestrator Stub"
Cohesion: 1.0
Nodes (0): 

### Community 224 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 225 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 

### Community 226 - "Session Store Inner"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **685 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `ExpectedFacts`, `ExpectedFact` (+680 more)
