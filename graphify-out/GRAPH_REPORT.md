...
## Corpus Check
- Large corpus: 627 files · ~351,280 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6819 nodes · 11066 edges · 224 communities detected
...
### Community 6 - "Brain Steps 72-77 Integration"
Cohesion: 0.03
Nodes (85): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), AgTypeParam, Cypher (+77 more)

### Community 7 - "Long Conversation Smoke Tests"
Cohesion: 0.02
Nodes (77): canonical_json_bytes(), canonical_payload_hash(), chain_detects_tampered_payload(), HashChain, next_chain_hash(), AuditError, classifies_rate_limit_as_retryable(), classifies_repeated_timeout_as_reprovision() (+69 more)

### Community 8 - "Embedding Provider"
Cohesion: 0.02
Nodes (66): ClientConfig, decode_response(), decode_stream_chunk(), expect_success(), expect_success_json(), extract_exit_code(), http_error(), OrchestratorClient (+58 more)

### Community 9 - "Tool Types & Policy"
Cohesion: 0.03
...
### Community 10 - "Slow Path Ingestion Tests"
Cohesion: 0.03
...
### Community 14 - "LLM Gateway Service"
Cohesion: 0.05
...
### Community 17 - "Turn Execution Workflow"
Cohesion: 0.06
...
### Community 21 - "Turn & Tool Dispatch"
Cohesion: 0.04
...
### Community 23 - "Graph Write & Export"
Cohesion: 0.06
...
### Community 24 - "Turn Runner Helpers"
Cohesion: 0.05
...
### Community 31 - "Eval Fixtures & Pricing"
Cohesion: 0.06
...
### Community 35 - "Skill Tier1 Metadata"
Cohesion: 0.06
...
### Community 37 - "Telemetry Init"
Cohesion: 0.06
Nodes (34): from_reader_requires_postgres_url(), from_reader_uses_defaults_and_optional_values(), is_prod_value(), linux_memory_gb(), OrchestratorConfig, parse_otlp_headers(), parse_otlp_protocol(), production_environment() (+26 more)
...
### Community 40 - "History Compilation"
Cohesion: 0.05
...
### Community 41 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 42 - "Fact Extraction & Chunking"
Cohesion: 0.08
...
### Community 45 - "Runtime Task Monitor"
Cohesion: 0.06
...
### Community 56 - "Lineage Event Records"
Cohesion: 0.05
...
### Community 58 - "Skill Regression Runs"
Cohesion: 0.09
...
### Community 59 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 60 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 62 - "Completion Content Types"
Cohesion: 0.07
...
### Community 64 - "Orchestrator Test Fixture"
Cohesion: 0.1
...
### Community 65 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 66 - "Citation Vendor Adapters"
Cohesion: 0.12
...
### Community 68 - "Live Ingestion E2E"
Cohesion: 0.14
...
### Community 70 - "Session Event Store"
Cohesion: 0.07
Nodes (1): PostgresSessionStore

### Community 71 - "LLM Span Instrumentation"
Cohesion: 0.12
...
### Community 72 - "Intent Manager Service"
Cohesion: 0.09
...
### Community 73 - "Live Cache Audit Tests"
Cohesion: 0.13
...
### Community 74 - "Long Conversation Score Card"
Cohesion: 0.14
...
### Community 84 - "Query Rewrite Postprocess"
Cohesion: 0.11
...
### Community 85 - "Session Blob Store"
Cohesion: 0.18
...
### Community 88 - "Local Hand Provider"
Cohesion: 0.16
Nodes (3): detect_docker(), docker_status(), LocalHandProvider

### Community 89 - "Task Segment Tracker"
Cohesion: 0.12
...
### Community 90 - "Pricing & Cost Math"
Cohesion: 0.16
Nodes (17): cost_cents_for_anthropic_sonnet_matches_pricing_table_v1_for_known_token_counts(), cost_cents_for_gemini_pro_matches_pricing_table_v1_for_known_token_counts(), cost_cents_for_openai_gpt41_matches_pricing_table_v1_for_known_token_counts(), cost_cents_rounds_up_to_nearest_cent_at_final_step_only(), cost_cents_with_cached_input_tokens_uses_discounted_rate(), expected_from_row(), pricing_row(), round_up() (+9 more)

### Community 91 - "Session Turn Lifecycle Tests"
Cohesion: 0.17
...
### Community 95 - "Scripted Provider"
Cohesion: 0.13
Nodes (3): ScriptedBlock, ScriptedProvider, ScriptedResponse

### Community 96 - "Session Store Handlers"
Cohesion: 0.09
Nodes (1): SessionStoreImpl

### Community 97 - "Cache Observability"
Cohesion: 0.18
...
### Community 98 - "Cache Control Markers Test"
Cohesion: 0.2
...
### Community 100 - "Session Store Inner Impl"
Cohesion: 0.1
Nodes (1): SessionStoreImpl
...
### Community 103 - "Postgres Session Store"
Cohesion: 0.19
Nodes (1): PostgresSessionStore

### Community 104 - "Grep Tool"
Cohesion: 0.17
...
### Community 105 - "Tool Router Construction"
Cohesion: 0.13
Nodes (2): default_cloud_provider(), ToolRouter

### Community 106 - "Approval Token Auth"
Cohesion: 0.15
...
### Community 110 - "Brain Steps 72-77 E2E"
Cohesion: 0.19
...
### Community 111 - "Recorded Scripted Provider"
Cohesion: 0.2
Nodes (6): is_compaction_request(), latest_user_message(), recorded_compaction_events(), RecordedProviderError, RecordedScriptedProvider, response_from_events()
...
### Community 113 - "Session Enum Conversions"
Cohesion: 0.12
Nodes (0): 
...
### Community 123 - "Cross-Tenant Isolation Loadtest"
Cohesion: 0.21
...
### Community 125 - "Lexical Ranking Tests"
Cohesion: 0.4
Nodes (13): configured_test_db(), fact(), graph_store(), insert_fact(), lexical_search_confidence_weight_dominates_when_recency_and_refs_equal(), lexical_search_excludes_invalidated_nodes_with_valid_to_set(), lexical_search_orders_results_by_combined_recency_confidence_reference_score(), lexical_search_recency_weight_dominates_when_confidence_and_refs_equal() (+5 more)
...
### Community 129 - "Client Smoke Tests"
Cohesion: 0.23
...
### Community 132 - "Prompt Injection Detection"
Cohesion: 0.26
...
### Community 133 - "Turn Execution Smoke Tests"
Cohesion: 0.32
...
### Community 162 - "Moa Config Loader"
Cohesion: 0.46
Nodes (1): MoaConfig

### Community 163 - "Provider Request Body Snapshots"
Cohesion: 0.43
...
### Community 164 - "Session VO Tests"
Cohesion: 0.5
...
### Community 172 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 181 - "Shell Chain Splitter"
Cohesion: 0.5
Nodes (2): push_sub_command(), split_shell_chain()

### Community 182 - "Scoped Transaction Lifecycle"
Cohesion: 0.5
Nodes (1): ScopedConn<'p>

### Community 183 - "Unified Diff"
Cohesion: 0.6
...
### Community 208 - "Serialized Test Guard"
Cohesion: 1.0
...
### Community 210 - "Lineage Postgres Tests"
Cohesion: 1.0
Nodes (0): 
...
### Community 218 - "Workspace Hack Build"
Cohesion: 1.0
Nodes (0): 

### Community 219 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 220 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 
