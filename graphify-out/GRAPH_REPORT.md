...
## Corpus Check
- Large corpus: 717 files · ~395,581 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7615 nodes · 12362 edges · 239 communities detected
...
Cohesion: 0.01
Nodes (214): AsyncAuthzConfig, AsyncAuthzKind, default_timeout_secs(), build_default_pipeline(), build_default_pipeline_with_tools(), GraphMemoryPipelineOptions, CompiledRequest, TurnUsage (+206 more)

### Community 1 - "PII Redaction Core"
Cohesion: 0.01
Nodes (121): ChangelogRecord, validate_scope(), write_and_bump(), acknowledgement(), command_action(), control_action_for_inbound(), GatewayControlAction, EdgeLabel (+113 more)
...
Cohesion: 0.02
Nodes (136): anthropic_offline_429_response_triggers_retry_with_backoff(), anthropic_offline_500_response_triggers_retry_then_surfaces_typed_error(), anthropic_offline_completion_returns_text_for_minimal_request(), anthropic_offline_malformed_json_response_returns_typed_parse_error(), anthropic_offline_streaming_disconnect_mid_response_surfaces_typed_error_with_partial_events(), anthropic_offline_streaming_yields_text_deltas_then_terminal_event(), anthropic_offline_tool_call_response_parses_into_provider_event(), provider() (+128 more)

### Community 4 - "Sub-Agent Handlers"
Cohesion: 0.02
Nodes (87): AgentRegistry, AgentRegistryImpl, operator_user_id(), register_agent_inner(), RegisterAgentRequest, RegisterAgentResponse, AgentTemplates, AgentTemplatesImpl (+79 more)

### Community 5 - "Merkle Tree Audit"
Cohesion: 0.02
Nodes (93): ApprovalReaper, ApprovalReaperHandle, HttpAwakeableResolver, ReaperError, AwakeableResolveError, AwakeableResolver, canonical_json_bytes(), canonical_payload_hash() (+85 more)
...
### Community 7 - "Embedding Provider"
Cohesion: 0.02
Nodes (57): AgentActAsRequest, AgentSummary, AgentTemplateSummary, apply_auth_headers(), ApprovalSummary, AuditVerifyResponse, body_for_tuple_op(), client_from_credentials() (+49 more)

### Community 8 - "Slow Path Ingestion Tests"
Cohesion: 0.02
...
### Community 9 - "Cache Observability"
Cohesion: 0.02
Nodes (73): DaemonCommand, DaemonInfo, DaemonReply, DaemonSessionPreview, DaemonStreamEvent, approval_requested_event_round_trips_full_prompt(), Event, sample_approval_prompt() (+65 more)

### Community 10 - "Schema Migration"
Cohesion: 0.03
...
### Community 17 - "Telemetry Init"
Cohesion: 0.04
Nodes (51): auth0_without_feature_returns_feature_missing(), build_providers(), build_providers_with_resolver(), BuildError, env_value(), HybridAuthProvider, Providers, authz_openfga_env_maps_into_moa_config() (+43 more)

### Community 18 - "Graph Write & Export"
Cohesion: 0.05
Nodes (67): Args, begin_audited_read(), collect_changelog(), collect_embeddings(), collect_entities(), collect_facts(), collect_nodes(), collect_relationships() (+59 more)

### Community 19 - "Eval Fixtures & Pricing"
Cohesion: 0.04
Nodes (45): fixture_path(), transcript_jsonl_round_trips_through_read_and_write(), ConsolidationOutcomes, MemoryScenario, is_compaction_request(), latest_user_message(), recorded_compaction_events(), RecordedProviderError (+37 more)

### Community 20 - "Session Enum Conversions"
Cohesion: 0.05
...
### Community 21 - "Concurrent Event Monotonicity Tests"
Cohesion: 0.07
Nodes (65): active_nodes_named(), assert_changelog_forms_dag(), changelog_edges(), changelog_version(), ChangelogEdge, concurrent_supersede_with_contradicting_facts_chooses_one_deterministically(), concurrent_supersedes_of_same_node_serialize_with_monotonic_changelog_versions(), concurrent_writes_to_different_nodes_in_same_workspace_do_not_interfere() (+57 more)
...
### Community 25 - "Fast Ingestion Path"
Cohesion: 0.05
...
### Community 27 - "Session Replay Snapshots"
Cohesion: 0.05
...
### Community 28 - "Approval Token Auth"
Cohesion: 0.04
...
### Community 29 - "Turn Runner Helpers"
Cohesion: 0.05
...
### Community 30 - "Provider Streaming"
Cohesion: 0.05
...
### Community 31 - "Intent Discovery Workflow"
Cohesion: 0.05
...
### Community 32 - "Contradiction Detection"
Cohesion: 0.06
...
### Community 33 - "Workspace Instructions"
Cohesion: 0.06
...
### Community 34 - "Cross-Tenant Pentest Suite"
Cohesion: 0.07
...
### Community 35 - "Object State Management"
Cohesion: 0.06
Nodes (28): AppState, Auth0ConnectionLinkedWebhook, extract_credential(), handle_auth0_connection_webhook(), handle_proxy(), lookup_auth0_user_id(), response_to_axum(), RouteTranslation (+20 more)

### Community 36 - "Eval Budget Checker"
Cohesion: 0.06
...
### Community 39 - "Skill Lessons & Render"
Cohesion: 0.05
Nodes (24): insert_addendum(), learn_lesson(), lesson_name(), LessonContext, set_app_role(), body_hash(), estimate_skill_tokens(), insert_skill() (+16 more)
...
### Community 43 - "Skill Frontmatter Format"
Cohesion: 0.08
Nodes (14): defaults_missing_moa_metadata(), estimate_skill_tokens(), format_timestamp(), is_valid_skill_name(), metadata_csv(), parse_skill_markdown(), parses_valid_skill_markdown(), render_skill_markdown() (+6 more)
...
### Community 50 - "Tool Result Store"
Cohesion: 0.06
...
### Community 51 - "Turn & Tool Dispatch"
Cohesion: 0.06
Nodes (23): build_turn_context(), BuildTurnContextOptions, persist_context_snapshot(), append_tool_call_event(), emit_tool_output_warning(), execute_pending_tool(), execute_tool(), format_tool_output() (+15 more)

### Community 52 - "Runtime Context Stage"
Cohesion: 0.08
...
### Community 53 - "Runtime Task Monitor"
Cohesion: 0.06
...
### Community 55 - "Workspace Promotion"
Cohesion: 0.08
...
### Community 56 - "Audit Signing Keys"
Cohesion: 0.08
...
### Community 57 - "Agent Adapter"
Cohesion: 0.06
Nodes (3): AgentAdapter, SessionTurnAdapter, SubAgentTurnAdapter

### Community 58 - "Long Conversation Smoke Tests"
Cohesion: 0.08
...
### Community 59 - "Slow Ingestion Path"
Cohesion: 0.1
...
### Community 63 - "Provider Request Builder"
Cohesion: 0.09
...
### Community 64 - "Lineage Event Records"
Cohesion: 0.05
...
### Community 65 - "Approval Request Types"
Cohesion: 0.07
...
### Community 66 - "Skill Regression Runs"
Cohesion: 0.09
...
### Community 67 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 68 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 70 - "pgvector Store"
Cohesion: 0.1
Nodes (21): backfill_from(), listen_stream_backfills_from_last_seen_sequence(), listen_stream_receives_cross_store_events_in_order(), NotifyPayload, rolled_back_notify_is_not_observed(), run_listener_task(), seed_session(), session_channel_name() (+13 more)
...
### Community 73 - "Orchestrator Test Fixture"
Cohesion: 0.1
...
### Community 74 - "Encrypted Secret Vault"
Cohesion: 0.11
...
### Community 75 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 76 - "Citation Vendor Adapters"
Cohesion: 0.12
...
### Community 78 - "Session Event Store"
Cohesion: 0.07
Nodes (1): PostgresSessionStore

### Community 79 - "Gemini Embedder"
Cohesion: 0.09
...
### Community 80 - "Long Conversation Score Card"
Cohesion: 0.14
...
### Community 81 - "LLM Span Instrumentation"
Cohesion: 0.12
...
### Community 82 - "Intent Manager Service"
Cohesion: 0.09
...
### Community 83 - "Live Cache Audit Tests"
Cohesion: 0.13
...
### Community 88 - "Embedding Provider Traits"
Cohesion: 0.12
...
### Community 94 - "Task Segment Tracker"
Cohesion: 0.12
...
### Community 95 - "Session Turn Lifecycle Tests"
Cohesion: 0.17
...
### Community 101 - "Conversation Compaction"
Cohesion: 0.15
...
### Community 103 - "Postgres Session Store Tests"
Cohesion: 0.23
...
### Community 107 - "CLI Skills Command"
Cohesion: 0.21
Nodes (16): bootstrap_global_skills(), cli_export_import_round_trips_skill_body(), current_workspace_id(), discover_skill_files(), export_skills(), handle_skills_command(), import_skills(), is_skill_markdown_file() (+8 more)

### Community 108 - "Gateway Rate Limiter"
Cohesion: 0.15
Nodes (3): GatewayRateLimiter, GatewayRateLimitMetrics, GatewaySendResponse

### Community 109 - "Tenant Intent Store"
Cohesion: 0.12
Nodes (1): PostgresSessionStore
...
### Community 111 - "Brain Steps 72-77 E2E"
Cohesion: 0.19
...
### Community 112 - "CLI Exec Command"
Cohesion: 0.15
...
### Community 113 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 114 - "Security Policies"
Cohesion: 0.23
...
### Community 115 - "Long Conversation Foundation Tests"
Cohesion: 0.18
...
### Community 116 - "Retrieval Load Scenario"
Cohesion: 0.2
...
### Community 117 - "Vector Backend Selection"
Cohesion: 0.18
...
### Community 125 - "Segment Store"
Cohesion: 0.16
Nodes (1): PostgresSessionStore

### Community 126 - "Provider Retry Policy"
Cohesion: 0.27
...
### Community 128 - "Verification Signal"
Cohesion: 0.19
Nodes (7): classify_command(), command_text(), override_for_events(), score(), verification_attempts(), VerificationAttempt, VerificationKind

### Community 129 - "Tool Signal"
Cohesion: 0.2
...
### Community 131 - "Client Smoke Tests"
Cohesion: 0.23
...
### Community 134 - "Turn Execution Smoke Tests"
Cohesion: 0.32
...
### Community 141 - "Anthropic Provider"
Cohesion: 0.26
Nodes (1): AnthropicProvider

### Community 142 - "Segment Scoring"
Cohesion: 0.38
...
### Community 149 - "DSAR Audit Export Tests"
Cohesion: 0.45
...
### Community 152 - "Intent Classifier"
Cohesion: 0.33
...
### Community 155 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 156 - "Tool Lifecycle Manager"
Cohesion: 0.29
Nodes (4): hand_id(), sandbox_tier_label(), session_provider_key(), ToolRouter

### Community 157 - "Instruction Stage"
Cohesion: 0.38
...
### Community 165 - "Session VO Tests"
Cohesion: 0.5
...
### Community 174 - "Auth0 Live Tests"
Cohesion: 0.57
Nodes (6): auth0_authenticate_valid_token_returns_identity(), auth0_expired_token_returns_expired(), auth0_wrong_audience_returns_rejected(), live_env(), LiveEnv, required_env()

### Community 175 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 176 - "Pgaudit Smoke Tests"
Cohesion: 0.6
...
### Community 187 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 

### Community 188 - "Fake Clock Test Helper"
Cohesion: 0.4
Nodes (1): FakeClock

### Community 189 - "Neon Branch Maintenance"
Cohesion: 0.4
Nodes (3): NeonMaint, NeonMaintImpl, PruneReport

### Community 190 - "Authz Outbox Tests"
Cohesion: 0.7
...
### Community 191 - "Client Runtime Tests"
Cohesion: 0.7
...
### Community 210 - "Builtin Authz Approval Test"
Cohesion: 0.67
Nodes (0): 

### Community 211 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 212 - "Vector Error Mapping"
Cohesion: 1.0
Nodes (1): moa_core::MoaError

### Community 213 - "Identity Headers Test"
Cohesion: 1.0
Nodes (0): 
...
### Community 221 - "Shell Chaining Security Test"
Cohesion: 1.0
Nodes (0): 

### Community 222 - "Lineage Postgres Tests"
Cohesion: 1.0
Nodes (0): 

### Community 223 - "Restate Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::Context<'_>

### Community 224 - "Restate Object Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::ObjectContext<'_>

### Community 225 - "Restate Shared Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::SharedObjectContext<'_>

### Community 226 - "Restate Workflow Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::WorkflowContext<'_>

### Community 227 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 228 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 229 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 230 - "History Budgeting"
Cohesion: 1.0
Nodes (0): 

### Community 231 - "History Error Preservation"
Cohesion: 1.0
Nodes (0): 

### Community 232 - "Skills Cache Break"
Cohesion: 1.0
Nodes (0): 

### Community 233 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 
...
### Community 235 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 236 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 237 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 238 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 
...
- **Should `Sub-Agent Handlers` be split into smaller, more focused modules?**
  _Cohesion score 0.02 - nodes in this community are weakly interconnected._
