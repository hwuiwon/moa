...
## Corpus Check
- 80 files · ~56,555 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1140 nodes · 1912 edges · 55 communities detected
...
9. `run_consolidation()` - 12 edges
10. `start_session()` - 12 edges
...
### Community 3 - "Skill Markdown Format"
Cohesion: 0.08
...
### Community 18 - "FTS5 Search Index"
Cohesion: 0.19
...
### Community 19 - "Session Picker View"
Cohesion: 0.18
...
### Community 20 - "Tool Approval Policies"
Cohesion: 0.22
...
### Community 22 - "Skill Improver & Distiller"
Cohesion: 0.21
...
### Community 24 - "Local Hand Provider"
Cohesion: 0.19
Nodes (2): detect_docker(), LocalHandProvider

### Community 25 - "Memory Maintenance Tests"
Cohesion: 0.29
...
### Community 26 - "Session DB Queries"
Cohesion: 0.29
...
### Community 30 - "History Compilation Stage"
Cohesion: 0.25
...
### Community 31 - "TUI Keybindings"
Cohesion: 0.2
Nodes (1): KeyAction

### Community 32 - "Prompt Widget"
Cohesion: 0.31
Nodes (2): build_textarea(), PromptWidget

### Community 33 - "Session Store Tests"
Cohesion: 0.2
Nodes (0): 

### Community 34 - "Tool Card Widget"
Cohesion: 0.42
Nodes (7): border_line(), content_line(), render_tool_card(), status_label(), status_style(), truncate_to_width(), wrap_text()

### Community 35 - "Memory Store Tests"
Cohesion: 0.43
...
### Community 45 - "File Search Tool"
Cohesion: 0.67
Nodes (3): collect_matches(), execute(), FileSearchInput

### Community 46 - "File Read Tool"
Cohesion: 0.67
Nodes (3): execute(), FileReadInput, resolve_sandbox_path()

### Community 47 - "Chat Harness Example"
Cohesion: 0.83
Nodes (3): main(), resolve_session_db_path(), run_prompt()

### Community 48 - "Anthropic Provider Tests"
Cohesion: 0.67
Nodes (0): 

### Community 49 - "File Write Tool"
Cohesion: 0.67
Nodes (1): FileWriteInput

### Community 50 - "Anthropic Live Test"
Cohesion: 1.0
Nodes (0): 

### Community 51 - "Compaction"
Cohesion: 1.0
Nodes (0): 

### Community 52 - "Memory Search Helpers"
Cohesion: 1.0
Nodes (2): extract_search_keywords (stopword filter), extract_search_query

### Community 53 - "Live Brain Turn Test"
Cohesion: 1.0
Nodes (1): live_brain_turn_returns_brain_response test

### Community 54 - "Relevant Memory Page"
Cohesion: 1.0
Nodes (1): RelevantMemoryPage

## Knowledge Gaps
- **137 isolated node(s):** `LogChange`, `LogEntry`, `IngestReport`, `PageFrontmatter`, `ChangeOperation` (+132 more)
