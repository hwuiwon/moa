...
## Corpus Check
- Large corpus: 566 files · ~335,775 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6506 nodes · 10565 edges · 220 communities detected
...
Cohesion: 0.01
Nodes (203): PreparedTurnRequest, build_default_pipeline(), build_default_pipeline_with_tools(), GraphMemoryPipelineOptions, DatabaseConfig, DatabaseNeonConfig, Args, begin_app_scoped_tx() (+195 more)

### Community 1 - "PII Redaction Core"
Cohesion: 0.01
Nodes (118): ChangelogRecord, validate_scope(), write_and_bump(), acknowledgement(), command_action(), control_action_for_inbound(), GatewayControlAction, IngestCtx (+110 more)

### Community 2 - "Changelog Audit & RLS"
Cohesion: 0.02
Nodes (121): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), AgTypeParam, Cypher (+113 more)
...
### Community 10 - "Audit Errors & Merkle Chain"
Cohesion: 0.03
Nodes (59): canonical_json_bytes(), canonical_payload_hash(), chain_detects_tampered_payload(), HashChain, next_chain_hash(), AuditError, classifies_rate_limit_as_retryable(), classifies_repeated_timeout_as_reprovision() (+51 more)
...
### Community 12 - "Provider Streaming"
Cohesion: 0.03
Nodes (64): annotate_cache_control(), annotate_message_cache_control(), anthropic_output_config(), anthropic_text_block(), apply_cache_breakpoints(), build_cache_create_body(), build_completion_request(), build_contents_from_messages() (+56 more)
...
### Community 17 - "Slow Path Ingestion Tests"
Cohesion: 0.03
Nodes (42): approval_button_click_with_unknown_request_id_returns_stale_error_message(), approval_button_click_with_valid_callback_data_emits_decision_signal(), approval_buttons_after_decision_re_render_as_disabled_with_decision_marker(), approval_request_after_orchestrator_timeout_marks_buttons_as_expired(), ApprovalClickOutcome, ApprovalLifecycleState, ApprovalRecord, ApprovalStateTracker (+34 more)

### Community 18 - "Hybrid Retriever"
Cohesion: 0.04
...
### Community 20 - "Lineage MPSC Sink Writer"
Cohesion: 0.05
...
### Community 24 - "Intent Discovery Workflow"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (57): Args, begin_audited_read(), collect_changelog(), collect_embeddings(), collect_entities(), collect_facts(), collect_nodes(), collect_relationships() (+49 more)

### Community 27 - "Workspace Instructions"
Cohesion: 0.06
...
### Community 30 - "Fact Extraction & Chunking"
Cohesion: 0.06
...
### Community 32 - "Skill Tier1 Metadata"
Cohesion: 0.06
...
### Community 34 - "Golden E2E Fixtures"
Cohesion: 0.07
...
### Community 37 - "Query Planner & NER"
Cohesion: 0.07
...
### Community 38 - "History Compilation"
Cohesion: 0.05
...
### Community 39 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 41 - "Runtime Context Stage"
Cohesion: 0.08
...
### Community 45 - "Object State Management"
Cohesion: 0.08
...
### Community 48 - "Approval Always-Allow Tests"
Cohesion: 0.15
...
### Community 50 - "Gateway Message Renderer"
Cohesion: 0.09
...
### Community 52 - "Lineage Records & Stages"
Cohesion: 0.05
...
### Community 53 - "Approval Request Types"
Cohesion: 0.07
...
### Community 54 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 55 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 56 - "Tool Router Policy"
Cohesion: 0.07
...
### Community 57 - "Completion Content Types"
Cohesion: 0.07
...
### Community 60 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 61 - "Workspace Promotion"
Cohesion: 0.1
...
### Community 62 - "Citation Vendor Adapters"
Cohesion: 0.12
...
### Community 64 - "Session Event Store"
Cohesion: 0.07
Nodes (1): PostgresSessionStore

### Community 65 - "Concurrent Event Monotonicity Tests"
Cohesion: 0.12
...
### Community 66 - "LLM Span Instrumentation"
Cohesion: 0.12
...
### Community 67 - "Intent Manager Service"
Cohesion: 0.09
...
### Community 68 - "Live Cache Audit Tests"
Cohesion: 0.13
...
### Community 69 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 70 - "Audit Signing Keys"
Cohesion: 0.13
...
### Community 72 - "Live Observability Tests"
Cohesion: 0.11
...
### Community 73 - "Local Tools Integration Tests"
Cohesion: 0.13
...
### Community 74 - "Session Analytics"
Cohesion: 0.11
...
### Community 76 - "Citation Verifiers"
Cohesion: 0.13
...
### Community 77 - "Query Rewrite Postprocess"
Cohesion: 0.11
...
### Community 78 - "Orchestrator Contract Harness"
Cohesion: 0.17
...
### Community 79 - "Session Message Helpers"
Cohesion: 0.17
...
### Community 80 - "Session Blob Store"
Cohesion: 0.18
...
### Community 82 - "Local Hand Provider"
Cohesion: 0.16
Nodes (3): detect_docker(), docker_status(), LocalHandProvider

### Community 83 - "Task Segment Tracker"
Cohesion: 0.12
...
### Community 84 - "Vector Store Backend"
Cohesion: 0.13
...
### Community 90 - "Postgres Session Store"
Cohesion: 0.19
Nodes (1): PostgresSessionStore

### Community 91 - "Schema Migration"
Cohesion: 0.16
...
### Community 94 - "Tool Router Construction"
Cohesion: 0.13
Nodes (2): default_cloud_provider(), ToolRouter

### Community 95 - "Approval Token Auth"
Cohesion: 0.15
...
### Community 96 - "Session Store Inner Impl"
Cohesion: 0.11
Nodes (1): SessionStoreImpl

### Community 97 - "Conversation Compaction"
Cohesion: 0.17
...
### Community 98 - "Gateway Rate Limiter"
Cohesion: 0.15
Nodes (3): GatewayRateLimiter, GatewayRateLimitMetrics, GatewaySendResponse

### Community 99 - "Tenant Intent Store"
Cohesion: 0.12
Nodes (1): PostgresSessionStore

### Community 100 - "Live Provider Matrix"
Cohesion: 0.25
...
### Community 102 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 103 - "Security Policies"
Cohesion: 0.23
...
### Community 104 - "Retrieval Load Scenario"
Cohesion: 0.2
...
### Community 105 - "Tool Output Budget"
Cohesion: 0.24
...
### Community 106 - "Mock Smoke Loadtest"
Cohesion: 0.2
...
### Community 107 - "AGE Graph Read"
Cohesion: 0.16
Nodes (5): AgeGraphStore, fetch_node(), fetch_nodes(), fetch_nodes_by_uid(), parse_agtype_uuid()

### Community 108 - "Platform Message Types"
Cohesion: 0.14
Nodes (12): ActionButton, Attachment, ButtonStyle, ChannelRef, DiffHunk, InboundMessage, MessageContent, OutboundMessage (+4 more)

### Community 109 - "Session Store Requests"
Cohesion: 0.13
Nodes (14): AppendEventRequest, CompleteSegmentRequest, CreateSegmentRequest, GetEventsRequest, GetSegmentBaselineRequest, InitSessionVoRequest, ListSkillResolutionRatesRequest, RecordSegmentSkillActivationRequest (+6 more)
...
### Community 113 - "Gateway Edit Window"
Cohesion: 0.25
...
### Community 114 - "Segment Store"
Cohesion: 0.16
Nodes (1): PostgresSessionStore

### Community 115 - "Provider Retry Policy"
Cohesion: 0.27
...
### Community 116 - "Resolution Scorer"
Cohesion: 0.25
...
### Community 117 - "Verification Signal"
Cohesion: 0.19
...
### Community 120 - "Prometheus Metrics Tests"
Cohesion: 0.23
...
### Community 138 - "Intent Classifier"
Cohesion: 0.33
...
### Community 141 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 144 - "Rewrite & Compaction Triggers"
Cohesion: 0.24
Nodes (5): approximate_query_tokens(), QueryRewriter, should_apply_tier2(), starts_with_tool_like_verb(), token_count()

### Community 145 - "Context Snapshot"
Cohesion: 0.22
Nodes (3): ContextSnapshot, FileReadDedupState, SnapshotFileReadState

### Community 146 - "Sub-Agent Handlers"
Cohesion: 0.22
Nodes (2): maybe_resolve_parent_awakeable(), SubAgentImpl

### Community 147 - "Bash Tool"
Cohesion: 0.39
...
### Community 154 - "Provider Request Body Snapshots"
Cohesion: 0.43
...
### Community 155 - "Session VO Tests"
Cohesion: 0.5
...
### Community 156 - "Session Object Handlers"
Cohesion: 0.29
Nodes (1): SessionImpl

### Community 157 - "Health Service"
Cohesion: 0.32
Nodes (4): Health, HealthImpl, version_info_reports_expected_versions(), VersionInfo

### Community 158 - "Self Assessment Signal"
Cohesion: 0.29
Nodes (2): contains_any(), score()

### Community 159 - "Structural Signal"
Cohesion: 0.32
Nodes (5): baseline(), cold_start_returns_none(), is_high_outlier(), score(), SegmentMetrics

### Community 160 - "Lexical Seed Store"
Cohesion: 0.43
Nodes (2): LexicalStore, lookup_seed_rows()

### Community 161 - "Lineage Fjall Journal"
Cohesion: 0.29
Nodes (1): Journal

### Community 162 - "Daemon Protocol"
Cohesion: 0.52
...
### Community 166 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 177 - "Gemini Live Tests"
Cohesion: 0.6
...
### Community 178 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 

### Community 179 - "Fake Clock Test Helper"
Cohesion: 0.4
Nodes (1): FakeClock

### Community 180 - "Cohere Live Test"
Cohesion: 0.83
Nodes (3): cohere_embed_v4_returns_1024_dimensional_float_embeddings(), live_cohere_key(), live_cohere_requested()

### Community 181 - "Turbopuffer Live Tests"
Cohesion: 0.83
Nodes (3): basis_vector(), live_store(), turbopuffer_live_round_trip()

### Community 182 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn

### Community 183 - "Approval Rule Store"
Cohesion: 0.5
Nodes (1): PostgresSessionStore

### Community 184 - "Cohere Reranker Live Test"
Cohesion: 0.83
Nodes (3): cohere_rerank_v4_fast_prioritizes_relevant_retrieval_candidate(), live_cohere_key(), live_cohere_requested()

### Community 185 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 186 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 187 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 188 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 189 - "Permissions Config"
Cohesion: 0.67
Nodes (1): PermissionsConfig

### Community 190 - "Gateway Config"
Cohesion: 0.67
Nodes (1): GatewayConfig

### Community 191 - "Session Store Helpers"
Cohesion: 0.67
Nodes (1): PostgresSessionStore

### Community 192 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 193 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 194 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 195 - "Chunking Scaffold Test"
Cohesion: 1.0
Nodes (0): 

### Community 196 - "Vector Error Mapping"
Cohesion: 1.0
Nodes (1): moa_core::MoaError

### Community 197 - "Cold Tier Partition Tests"
Cohesion: 1.0
Nodes (0): 

### Community 198 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 199 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 200 - "Session Task Runner"
Cohesion: 1.0
Nodes (0): 

### Community 201 - "Shell Chaining Security Test"
Cohesion: 1.0
Nodes (0): 

### Community 202 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0): 

### Community 203 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 204 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 205 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 206 - "History Budgeting"
Cohesion: 1.0
Nodes (0): 

### Community 207 - "History Error Preservation"
Cohesion: 1.0
Nodes (0): 

### Community 208 - "History Compaction Compile"
Cohesion: 1.0
Nodes (1): HistoryCompiler

### Community 209 - "Skills Cache Break"
Cohesion: 1.0
Nodes (0): 

### Community 210 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 211 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 212 - "Workspace Hack Build"
Cohesion: 1.0
Nodes (0): 

### Community 213 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 214 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 215 - "Brain Orchestrator Stub"
Cohesion: 1.0
Nodes (0): 

### Community 216 - "Local Orchestrator Stub"
Cohesion: 1.0
Nodes (0): 

### Community 217 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 218 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 

### Community 219 - "Session Store Inner"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **638 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `ExpectedFacts`, `ExpectedFact` (+633 more)
