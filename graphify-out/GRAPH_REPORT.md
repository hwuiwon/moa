...
## Corpus Check
- Large corpus: 392 files · ~325,536 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6092 nodes · 10860 edges · 183 communities detected
...
3. `LocalChatRuntime` - 36 edges
4. `DaemonChatRuntime` - 35 edges
5. `SkillFrontmatter` - 33 edges
6. `CountedSessionStore` - 32 edges
7. `FileMemoryStore` - 31 edges
8. `session()` - 31 edges
9. `start_session()` - 30 edges
10. `ToolRouter` - 30 edges
...
- `build_daemon_target()` --calls--> `expand_local_path()`  [EXTRACTED]
  crates/moa-loadtest/src/lib.rs → crates/moa-memory/src/lib.rs
...
Cohesion: 0.01
Nodes (138): ChangelogRecord, validate_scope(), write_and_bump(), IngestCtx, IngestRuntime, install_runtime(), install_runtime_with_pool(), OrchestratorCtx (+130 more)

### Community 1 - "Runtime Events & SSE"
Cohesion: 0.02
Nodes (101): CatalogIntent, IntentSource, IntentStatus, LearningEntry, TenantIntent, append_footer(), artifact_storage_footer(), bash_invocation() (+93 more)

### Community 2 - "Core Errors & Traits"
Cohesion: 0.01
Nodes (78): context_message_assistant_tool_call_preserves_invocation(), context_message_tool_result_preserves_text_and_blocks(), context_message_tool_still_defaults_to_text_only(), ContextMessage, estimate_text_tokens(), ExcludedItem, MessageRole, ProcessorOutput (+70 more)

### Community 3 - "Brain Integration Tests"
Cohesion: 0.02
Nodes (84): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), CollectedExecution, collector_tracks_tool_steps_and_metrics() (+76 more)

### Community 4 - "Skill Document Format"
Cohesion: 0.03
Nodes (78): append_skill_learning(), build_distillation_prompt(), count_tool_calls(), extract_task_summary(), find_similar_skill(), maybe_distill_skill(), maybe_distill_skill_with_learning(), normalize_new_skill() (+70 more)
...
### Community 7 - "Exec Command Flow"
Cohesion: 0.03
Nodes (71): bash_output_preserves_full_process_streams(), bash_output_small_streams_are_not_truncated(), BashToolInput, build_bash_output(), execute_docker(), execute_local(), batcher_holds_events_until_interval_elapses(), flush_returns_remaining_events() (+63 more)

### Community 8 - "Memory Types & Scopes"
Cohesion: 0.02
Nodes (48): ConfidenceLevel, count_ingest_pages(), derive_source_name_from_content(), extract_search_keywords(), extract_search_query(), extract_search_query_from_messages(), fast_memory_policy(), format_ingest_report() (+40 more)

### Community 9 - "Brain Turn Tests"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (72): approval_requested_event_persists_full_prompt_details(), blank_session_waits_for_first_message(), burst_of_queued_messages_preserves_fifo_under_hot_session_pressure(), collect_runtime_events_until(), compaction_uses_auxiliary_model_router_tier(), completed_tool_turn_destroys_cached_hand(), create_test_store(), CurrentDirGuard (+64 more)

### Community 11 - "Skill Injection Stage"
Cohesion: 0.04
Nodes (88): allowed_tools(), alphabetical_name_cmp(), bootstrap_global_skills(), budget_limit_skips_expensive_tests(), capabilities(), cli_export_import_round_trips_skill_body(), compare_ranked_skills(), compute_budget_uses_context_window_percentage_or_default_floor() (+80 more)

### Community 12 - "Core Config"
Cohesion: 0.03
Nodes (55): budget_config_defaults_are_applied(), BudgetConfig, CloudConfig, CloudFlyioConfig, CloudHandsConfig, compaction_config_defaults_are_applied(), CompactionConfig, config_loads_from_file() (+47 more)

### Community 13 - "Memory Store Tests"
Cohesion: 0.03
Nodes (58): Consolidate, ConsolidateImpl, ConsolidateReport, ConsolidateRequest, memory_page(), object_url(), register_deployment(), spawn_orchestrator() (+50 more)
...
### Community 17 - "Local Chat Runtime"
Cohesion: 0.03
...
### Community 18 - "Memory Consolidation"
Cohesion: 0.05
Nodes (68): append_change_manifest(), branch_dir(), branch_file_path(), branch_root(), ChangeOperation, ChangeRecord, list_branches(), merge_markdown() (+60 more)

### Community 19 - "Anthropic Provider"
Cohesion: 0.06
...
### Community 28 - "Contradiction Detection"
Cohesion: 0.05
...
### Community 30 - "Orchestrator Test Harness"
Cohesion: 0.05
Nodes (45): approval_allow_once_round_trip_through_restate(), configured_env(), live_model(), object_url(), register_deployment(), spawn_orchestrator(), wait_for_approval_request(), wait_for_status() (+37 more)
...
### Community 33 - "Legacy Wiki Search"
Cohesion: 0.08
Nodes (38): add_rrf_score(), claim_embedding_batch_sql(), classify_embedding_error(), confidence_as_str(), delete_queue_rows(), embedding_failures_counter(), embedding_queue_depth_gauge(), EmbeddingIndexStatus (+30 more)
...
### Community 35 - "Memory Detail Panel"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (37): approval_prompt_str_replace_diff_is_surgical(), approval_prompt_uses_remembered_workspace_root_for_commands(), bash_captures_stdout_and_stderr(), bash_error_output_is_not_truncated(), bash_respects_timeout(), bash_success_output_is_truncated_to_router_budget(), EmptyMemoryStore, file_operations_reject_path_traversal() (+29 more)

### Community 37 - "Cache Optimizer"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (32): add_session_trace_link(), apply_session_trace(), CacheReport, fingerprint_json(), full_request_fingerprint(), generate_trace_tags(), normalize_environment(), sanitize_langfuse_id() (+24 more)

### Community 39 - "Turn Streaming & Approvals"
Cohesion: 0.05
...
### Community 40 - "Fact Extraction & SSE"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (24): build_url(), classify_error(), DaytonaHandProvider, default_headers(), derive_toolbox_url(), expect_success(), expect_success_json(), extract_workspace_id() (+16 more)

### Community 42 - "Markdown Stream Healing"
Cohesion: 0.08
...
### Community 43 - "Query Planner & NER"
Cohesion: 0.07
...
### Community 44 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 45 - "Tool Result Store"
Cohesion: 0.06
...
### Community 48 - "E2B Sandbox Provider"
Cohesion: 0.12
...
### Community 49 - "Wiki Search Index"
Cohesion: 0.1
Nodes (20): add_rrf_score(), confidence_as_str(), EmbeddingIndexStatus, ensure_metrics_registered(), page_type_as_str(), parse_confidence(), parse_page_type(), qualified_name() (+12 more)
...
### Community 52 - "MCP Client Discovery"
Cohesion: 0.11
...
### Community 53 - "Eval Engine & Plan"
Cohesion: 0.11
Nodes (22): build_error_result(), cleanup_workspace(), dry_run_marks_results_skipped(), EngineOptions, EvalEngine, EvalRun, extract_trace_id(), fs_try_exists() (+14 more)

### Community 54 - "Completion Request Types"
Cohesion: 0.07
...
### Community 55 - "Approval Request Types"
Cohesion: 0.08
...
### Community 57 - "Provider Selection & Routing"
Cohesion: 0.11
...
### Community 58 - "Eval Agent Setup"
Cohesion: 0.12
Nodes (30): AgentEnvironment, apply_skill_overrides(), build_agent_environment(), build_agent_environment_with_provider(), build_eval_policies(), build_pipeline(), build_skill_memory_path(), build_tool_router() (+22 more)

### Community 59 - "Desktop App Shell"
Cohesion: 0.08
Nodes (9): MoaApp, compact_is_tighter_than_comfortable(), current(), Density, Spacing, build_default_icon(), install(), TrayHandle (+1 more)

### Community 60 - "Slow Ingestion Path"
Cohesion: 0.11
Nodes (30): apply_decisions(), apply_one_decision(), ApplyOutcome, classifier_from_env(), ClassifierBackend, classify_fact(), classify_facts(), decision_fact() (+22 more)
...
### Community 62 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 63 - "Live Ingestion E2E"
Cohesion: 0.14
...
### Community 64 - "Tool Router Policy"
Cohesion: 0.09
...
### Community 65 - "LLM Span Instrumentation"
Cohesion: 0.12
...
### Community 66 - "Intent Manager Service"
Cohesion: 0.09
...
### Community 67 - "Live Cache Audit Tests"
Cohesion: 0.13
...
### Community 68 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 69 - "Command Palette & Keybindings"
Cohesion: 0.12
...
### Community 70 - "Live Observability Tests"
Cohesion: 0.11
...
### Community 71 - "Session DB Codecs"
Cohesion: 0.1
...
### Community 74 - "Brain Integration Steps"
Cohesion: 0.11
...
### Community 75 - "Embedding Provider"
Cohesion: 0.12
...
### Community 79 - "Telemetry & Logging"
Cohesion: 0.14
...
### Community 80 - "Scripted Test Provider"
Cohesion: 0.14
...
### Community 83 - "Chat Message Bubbles"
Cohesion: 0.17
...
### Community 84 - "OpenAI Privacy Filter"
Cohesion: 0.14
...
### Community 88 - "Task Segmentation"
Cohesion: 0.14
...
### Community 91 - "Live Provider Matrix"
Cohesion: 0.25
...
### Community 92 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 93 - "Security Policies"
Cohesion: 0.23
...
### Community 100 - "Session Search Tool"
Cohesion: 0.16
...
### Community 102 - "Session Row Badges"
Cohesion: 0.2
...
### Community 106 - "Query Planner Tests"
Cohesion: 0.15
Nodes (1): SeedGraph

### Community 107 - "Window State Persistence"
Cohesion: 0.28
...
### Community 114 - "Turn Loop Detector"
Cohesion: 0.33
...
### Community 115 - "Intent Classifier"
Cohesion: 0.33
...
### Community 122 - "Session VO Tests"
Cohesion: 0.5
...
### Community 131 - "Skill List Panel"
Cohesion: 0.38
Nodes (1): SkillList

### Community 132 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 142 - "Gemini Live Tests"
Cohesion: 0.6
...
### Community 143 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0):

### Community 144 - "Desktop Status Bar"
Cohesion: 0.5
Nodes (1): MoaStatusBar

### Community 145 - "Event Color Mapping"
Cohesion: 0.6
Nodes (2): event_color(), EventColor

### Community 146 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn
...
### Community 148 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 149 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 150 - "Settings Integration Tests"
Cohesion: 0.83
Nodes (3): removing_from_auto_approve_persists(), scratch_dir(), settings_mutations_round_trip_through_config_file()

### Community 151 - "Desktop Title Bar"
Cohesion: 0.67
Nodes (1): MoaTitleBar

### Community 152 - "General Settings Tab"
Cohesion: 0.67
Nodes (2): render_general_tab(), render_model_card()

### Community 153 - "Error Banner Component"
Cohesion: 0.67
Nodes (2): error_banner(), error_banner_any()

### Community 154 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 155 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 156 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0):

### Community 157 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0):

### Community 158 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 159 - "Sidebar Tab Enum"
Cohesion: 0.67
Nodes (1): SidebarTab

### Community 160 - "Permissions Settings Tab"
Cohesion: 1.0
Nodes (2): render_permissions_tab(), tool_list_card()

### Community 161 - "Desktop Service Init"
Cohesion: 0.67
Nodes (1): InitializedServices

### Community 162 - "Ingest Connector"
Cohesion: 1.0
Nodes (1): IngestConnector

### Community 163 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 164 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 165 - "Provider HTTP Client"
Cohesion: 1.0
Nodes (0):

### Community 166 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0):

### Community 167 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 168 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 169 - "Agent Adapter"
Cohesion: 1.0
Nodes (1): AgentAdapter

### Community 170 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0):

### Community 171 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0):

### Community 172 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 173 - "Keyboard Shortcuts Tab"
Cohesion: 1.0
Nodes (0):

### Community 174 - "Icon Button"
Cohesion: 1.0
Nodes (0):

### Community 175 - "Section Card"
Cohesion: 1.0
Nodes (0):

### Community 176 - "Segmented Control"
Cohesion: 1.0
Nodes (0):

### Community 177 - "Markdown Style"
Cohesion: 1.0
Nodes (0):

### Community 178 - "Nav Item"
Cohesion: 1.0
Nodes (0):

### Community 179 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0):

### Community 180 - "Core Type Macros"
Cohesion: 1.0
Nodes (0):

### Community 181 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0):

### Community 182 - "Restate Registration"
Cohesion: 1.0
Nodes (0):

## Knowledge Gaps
- **528 isolated node(s):** `LogChange`, `LogEntry`, `BootstrapReport`, `BootstrapSentinel`, `PageFrontmatter` (+523 more)
...
- **Should `Core Errors & Traits` be split into smaller, more focused modules?**
  _Cohesion score 0.01 - nodes in this community are weakly interconnected._
- **Should `Brain Integration Tests` be split into smaller, more focused modules?**
  _Cohesion score 0.02 - nodes in this community are weakly interconnected._
