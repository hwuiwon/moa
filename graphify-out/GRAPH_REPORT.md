...
## Corpus Check
- Corpus is ~29,638 words - fits in a single context window. You may not need a graph.

## Summary
- 625 nodes · 860 edges · 41 communities detected
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.79)
...
4. `ToolRouter` - 12 edges
5. `Spec Location Table` - 12 edges
6. `WorkingContext` - 10 edges
7. `AnthropicProvider` - 9 edges
8. `AnthropicStreamState` - 9 edges
...
### Community 2 - "Tool Registry & Router"
Cohesion: 0.09
...
### Community 4 - "Context Pipeline Core"
Cohesion: 0.1
...
### Community 5 - "Config & Error Types"
Cohesion: 0.08
...
### Community 6 - "Agent Instructions Doc"
Cohesion: 0.09
...
Cohesion: 0.19
Nodes (4): collect_markdown_files(), expand_local_path(), FileMemoryStore, try_exists()

### Community 11 - "Working Context Types"
Cohesion: 0.1
...
### Community 15 - "Session DB Queries"
Cohesion: 0.29
...
### Community 16 - "Event Types"
Cohesion: 0.18
Nodes (1): Event

### Community 17 - "Brain Turn Harness"
Cohesion: 0.31
...
### Community 19 - "Session Store Tests"
Cohesion: 0.2
Nodes (0): 

### Community 20 - "Memory Preload Stage"
Cohesion: 0.24
...
### Community 21 - "Core Trait Definitions"
Cohesion: 0.22
...
### Community 35 - "Anthropic Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 36 - "Compaction"
Cohesion: 1.0
Nodes (0): 

### Community 37 - "Memory Store Integration Tests"
Cohesion: 1.0
Nodes (1): FileMemoryStore Integration Tests

### Community 38 - "FTS Scope Helper"
Cohesion: 1.0
Nodes (1): FtsIndex::scopes_for_path

### Community 39 - "Live Brain Turn Test"
Cohesion: 1.0
Nodes (1): live_brain_turn_returns_brain_response test

### Community 40 - "Relevant Memory Page"
Cohesion: 1.0
...
## Knowledge Gaps
- **121 isolated node(s):** `FileMemoryStore Integration Tests`, `sample_page helper`, `create_read_update_and_delete_wiki_pages test`, `fts_search_finds_ranked_results test`, `rebuild_search_index_from_files_restores_results test` (+116 more)
...
- **Thin community `CLI Entry Point`** (2 nodes): `main.rs`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Anthropic Live Tests`** (2 nodes): `anthropic_live.rs`, `anthropic_live_completion_returns_expected_answer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Compaction`** (2 nodes): `compaction.rs`, `maybe_compact()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Memory Store Integration Tests`** (1 nodes): `FileMemoryStore Integration Tests`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
