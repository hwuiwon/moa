...
## Corpus Check
- Large corpus: 682 files · ~391,326 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7510 nodes · 12316 edges · 235 communities detected
...
4. `E2BHandProvider` - 23 edges
5. `LocalHandProvider` - 22 edges
6. `DaytonaHandProvider` - 22 edges
7. `main()` - 21 edges
...
Cohesion: 0.01
Nodes (211): AsyncAuthzConfig, AsyncAuthzKind, default_timeout_secs(), AuthzConfig, AuthzEngine, OpenFgaConfig, CompiledRequest, TurnUsage (+203 more)

### Community 1 - "PII Redaction Core"
Cohesion: 0.01
Nodes (135): ChangelogRecord, validate_scope(), write_and_bump(), acknowledgement(), command_action(), control_action_for_inbound(), GatewayControlAction, EdgeLabel (+127 more)

### Community 2 - "Postgres RLS & Audit Tests"
Cohesion: 0.02
Nodes (124): anthropic_offline_429_response_triggers_retry_with_backoff(), anthropic_offline_500_response_triggers_retry_then_surfaces_typed_error(), anthropic_offline_completion_returns_text_for_minimal_request(), anthropic_offline_malformed_json_response_returns_typed_parse_error(), anthropic_offline_streaming_disconnect_mid_response_surfaces_typed_error_with_partial_events(), anthropic_offline_streaming_yields_text_deltas_then_terminal_event(), anthropic_offline_tool_call_response_parses_into_provider_event(), provider() (+116 more)

### Community 3 - "Turn Wire Protocol"
Cohesion: 0.01
Nodes (147): accepted_eval_run_response(), attach_summary_field(), authorize_workspace(), block_on_current_thread(), compare_runs_for_workspace(), Eval, eval_ci_exit_code(), EvalDatasetItemInsert (+139 more)

### Community 4 - "Skill Frontmatter Format"
Cohesion: 0.02
Nodes (84): append_skill_learning(), build_distillation_prompt(), count_tool_calls(), distill_skill_with_learning(), DistillationOutcome, DistillationSkipReason, extract_task_summary(), find_similar_skill() (+76 more)

### Community 5 - "Provider Pricing Tables"
Cohesion: 0.02
Nodes (77): ApprovalReaper, ApprovalReaperHandle, HttpAwakeableResolver, ReaperError, AwakeableResolveError, AwakeableResolver, canonical_json_bytes(), canonical_payload_hash() (+69 more)

### Community 6 - "Gemini Embedder"
Cohesion: 0.02
...
Cohesion: 0.03
Nodes (89): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), delete_filler_rows(), deterministic_vector() (+81 more)

### Community 8 - "Memory Scope Tool"
Cohesion: 0.03
Nodes (59): authorize_workspace(), checked_ingest_user_id(), checked_memory_scope(), CohereEmbedderConfig, contribution(), duration_ms_u32(), effective_user_id(), execute_memory_tool() (+51 more)

### Community 9 - "Analytics Ingest Runtime"
Cohesion: 0.03
Nodes (63): AdminMaintenance, AdminMaintenanceImpl, authorize_tenant_admin(), authorize_workspace_admin(), promotion_response_from_report(), promotion_update_response(), validate_promotion_action(), AgentRegistry (+55 more)
...
Cohesion: 0.03
Nodes (84): add_group_member(), create_group(), delete_group(), enqueue_group_mapping(), ensure_user_in_tenant(), fetch_group_by_id(), fetch_group_row_for_update(), fetch_groups_page() (+76 more)
...
Cohesion: 0.03
Nodes (88): BaseModel, apply_database_migrations(), Args, audit_moa_test_support_dev_dependency_only(), AuditDestination, best_effort_deregister(), bind_listener(), build_fga_client() (+80 more)
...
### Community 15 - "Orchestrator Test Harness"
Cohesion: 0.04
Nodes (61): approval_allow_once_round_trip_through_restate(), configured_env(), live_model(), object_url(), spawn_orchestrator(), wait_for_approval_request(), wait_for_brain_response_count(), wait_for_status() (+53 more)

### Community 16 - "Brain Turn Tests"
Cohesion: 0.04
...
### Community 17 - "Approval Token Auth"
Cohesion: 0.03
Nodes (65): AgentTemplates, AgentTemplatesImpl, AgentTemplateSummary, create_template_inner(), CreateAgentTemplateRequest, deactivate_template_inner(), enqueue_template_tuples(), ensure_same_tenant() (+57 more)
...
### Community 19 - "Workspace Instructions"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (62): actor_user_id(), AgentActAsRequest, Agents, AgentsImpl, AgentSummary, deactivate_agent_inner(), enqueue_agent_tuples(), ensure_same_tenant() (+54 more)

### Community 21 - "Lineage MPSC Sink Writer"
Cohesion: 0.04
...
### Community 22 - "Object State Management"
Cohesion: 0.04
Nodes (39): admin_maintenance_public_routes_translate_to_restate_handlers(), analytics_public_routes_translate_to_restate_handlers(), approval_public_routes_translate_to_restate_handlers(), AppState, Auth0ConnectionLinkedWebhook, credential_for_request(), DisabledAuth, eval_public_routes_translate_to_restate_handlers() (+31 more)

### Community 23 - "Concurrent Event Monotonicity Tests"
Cohesion: 0.07
Nodes (67): active_nodes_named(), assert_changelog_forms_dag(), changelog_edges(), changelog_version(), ChangelogEdge, concurrent_supersede_with_contradicting_facts_chooses_one_deterministically(), concurrent_supersedes_of_same_node_serialize_with_monotonic_changelog_versions(), concurrent_writes_to_different_nodes_in_same_workspace_do_not_interfere() (+59 more)

### Community 24 - "LLM Gateway Service"
Cohesion: 0.05
...
### Community 26 - "Session Enum Conversions"
Cohesion: 0.05
...
### Community 27 - "Fast Ingestion Path"
Cohesion: 0.05
...
### Community 29 - "Turn Execution Workflow"
Cohesion: 0.06
...
### Community 31 - "Session Replay Snapshots"
Cohesion: 0.05
...
### Community 32 - "Turn & Tool Dispatch"
Cohesion: 0.04
...
### Community 33 - "Privacy Service & JWT"
Cohesion: 0.06
...
### Community 34 - "Turn Runner Helpers"
Cohesion: 0.05
...
### Community 35 - "Provider Streaming"
Cohesion: 0.05
...
### Community 36 - "Contradiction Detection"
Cohesion: 0.06
...
### Community 38 - "Eval Budget Checker"
Cohesion: 0.06
...
### Community 41 - "Skill Tier1 Metadata"
Cohesion: 0.06
...
### Community 42 - "Golden E2E Fixtures"
Cohesion: 0.07
...
### Community 43 - "Orchestrator Test Fixture"
Cohesion: 0.08
Nodes (26): decode_response(), default_script(), Deployment, DeploymentsResponse, derive_admin_url(), ensure_postgres_image(), ensure_success(), IsolatedTest (+18 more)
...
### Community 45 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 46 - "Session Store Handlers"
Cohesion: 0.05
...
### Community 47 - "Runtime Context Stage"
Cohesion: 0.08
...
### Community 48 - "Fact Extraction & Chunking"
Cohesion: 0.08
...
### Community 49 - "Tool Result Store"
Cohesion: 0.06
...
### Community 50 - "Runtime Task Monitor"
Cohesion: 0.06
...
### Community 51 - "Provider Selection & Routing"
Cohesion: 0.08
...
### Community 52 - "DSAR Privacy Export"
Cohesion: 0.09
...
### Community 53 - "History Compilation"
Cohesion: 0.06
...
### Community 55 - "Audit Signing Keys"
Cohesion: 0.08
Nodes (28): active_key_for(), active_key_from_row(), active_or_create_key_tx(), ActiveKey, deterministic_seed(), ed25519_sign_with_rfc8032_test_keypair_produces_expected_signature(), ed25519_verify_fails_for_corrupted_signature_with_one_flipped_bit(), ed25519_verify_fails_for_message_with_one_flipped_bit() (+20 more)

### Community 56 - "Tool Executor Service"
Cohesion: 0.09
...
### Community 57 - "Long Conversation Smoke Tests"
Cohesion: 0.08
...
### Community 58 - "Slow Ingestion Path"
Cohesion: 0.1
...
### Community 59 - "Analytics Summaries"
Cohesion: 0.08
...
### Community 60 - "Vector Backend Selection"
Cohesion: 0.1
...
### Community 61 - "Gateway Message Renderer"
Cohesion: 0.09
...
### Community 64 - "Provider Request Builder"
Cohesion: 0.09
...
### Community 65 - "Lineage Event Records"
Cohesion: 0.05
...
### Community 66 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 67 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 68 - "Session Types"
Cohesion: 0.07
Nodes (28): BufferedUserMessage, CancelMode, CheckpointHandle, CheckpointInfo, ObserveLevel, pending_signal_queue_message_round_trip(), PendingSignal, PendingSignalType (+20 more)

### Community 69 - "Tool Router Policy"
Cohesion: 0.07
...
Cohesion: 0.1
Nodes (12): Auth0TokenVaultProvider, classify_token(), decrypt_bytes(), encrypt_bytes(), file_vault_encrypts_and_decrypts_roundtrip(), FileVault, pii_encryption_uses_fresh_nonce_per_field(), PiiVault (+4 more)

### Community 71 - "Completion Content Types"
Cohesion: 0.07
...
### Community 73 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 74 - "Citation Adapters"
Cohesion: 0.12
...
### Community 77 - "LLM Span Instrumentation"
Cohesion: 0.11
...
### Community 78 - "Skills Import Authz"
Cohesion: 0.11
Nodes (22): authorize_deployment_skill_admin(), authorize_workspace(), checked_import_scope(), effective_user_id(), export_inner(), import_inner(), list_inner(), memory_scope_from_skill() (+14 more)

### Community 79 - "Live Ingestion E2E Harness"
Cohesion: 0.15
Nodes (20): complex_ingestion_turn_writes_facts_pii_changelog_and_dedup(), degraded_workspace_skips_sampled_low_pii_turn_without_side_effects(), degraded_workspace_still_ingests_sensitive_turn(), fact_count(), fact_summaries(), ingestion_turn_round_trip_through_restate_is_idempotent(), LiveIngestionHarness, low_pii_degraded_skip_turn() (+12 more)
...
### Community 84 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 86 - "Local Tools Integration Tests"
Cohesion: 0.13
...
### Community 87 - "Citation Verifiers"
Cohesion: 0.13
...
### Community 88 - "Security Policies"
Cohesion: 0.13
...
### Community 89 - "Query Rewrite Postprocess"
Cohesion: 0.11
...
### Community 91 - "Cache Control Markers Test"
Cohesion: 0.18
...
### Community 94 - "Session Store Inner Impl"
Cohesion: 0.08
Nodes (2): owner_tuple_subject(), SessionStoreImpl

### Community 95 - "File Search Tool"
Cohesion: 0.13
...
### Community 96 - "Local Hand Provider"
Cohesion: 0.16
Nodes (3): detect_docker(), docker_status(), LocalHandProvider

### Community 97 - "Agent Adapter"
Cohesion: 0.11
...
### Community 99 - "Cache Fingerprinting"
Cohesion: 0.17
Nodes (17): CacheReport, canonical_json(), completion_request_fingerprints_are_json_object_order_insensitive(), fingerprint_json(), full_request_fingerprint(), generate_trace_tags(), normalize_environment(), sanitize_langfuse_id() (+9 more)

### Community 100 - "Scripted Test Provider"
Cohesion: 0.13
Nodes (3): ScriptedBlock, ScriptedProvider, ScriptedResponse

### Community 101 - "Approval Button State"
Cohesion: 0.15
...
### Community 102 - "Conversation Compaction"
Cohesion: 0.15
...
### Community 103 - "OpenAI Privacy Filter"
Cohesion: 0.14
...
### Community 108 - "Session Postgres Store Tests"
Cohesion: 0.25
Nodes (15): cleanup_schema(), create_test_store(), learning_log_round_trips_skill_entry_and_rollback_invalidates_batch(), postgres_event_payloads_round_trip_as_jsonb(), postgres_materialized_analytics_views_refresh(), postgres_session_ids_are_native_uuid_and_concurrent_emits_are_serialized(), postgres_session_owned_writes_fail_when_session_is_missing(), postgres_session_summary_tracks_model_tier_costs() (+7 more)

### Community 109 - "Live Provider Matrix"
Cohesion: 0.25
...
### Community 110 - "Lineage Sink Config"
Cohesion: 0.16
...
### Community 111 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 112 - "Long Conversation Foundation Tests"
Cohesion: 0.18
...
### Community 113 - "Retrieval Load Scenario"
Cohesion: 0.2
...
### Community 114 - "Tool Output Budget"
Cohesion: 0.24
...
### Community 115 - "Mock Smoke Loadtest"
Cohesion: 0.2
...
### Community 121 - "Segment Store"
Cohesion: 0.16
Nodes (1): PostgresSessionStore

### Community 122 - "Provider Retry Policy"
Cohesion: 0.27
...
### Community 123 - "Resolution Scorer"
Cohesion: 0.25
...
### Community 124 - "Loadtest Reporting"
Cohesion: 0.19
...
### Community 125 - "Auth0 CIBA Authz"
Cohesion: 0.22
Nodes (4): Auth0AsyncAuthzProvider, binding_message(), CibaPoller, PollOutcome

### Community 126 - "OpenAI Responses Envelope Tests"
Cohesion: 0.35
...
### Community 140 - "Turn Loop Detector"
Cohesion: 0.33
...
### Community 145 - "Tool Lifecycle Manager"
Cohesion: 0.29
Nodes (4): hand_id(), sandbox_tier_label(), session_provider_key(), ToolRouter

### Community 146 - "Instruction Stage"
Cohesion: 0.38
...
### Community 150 - "Gateway Rate Limit Tests"
Cohesion: 0.39
...
### Community 156 - "Approval Button Tests"
Cohesion: 0.32
...
### Community 157 - "Provider Request Body Snapshots"
Cohesion: 0.43
...
### Community 158 - "Session VO Tests"
Cohesion: 0.5
...
### Community 165 - "Null Token Vault"
Cohesion: 0.29
Nodes (1): NullTokenVaultProvider

### Community 166 - "Control Signal Tests"
Cohesion: 0.29
Nodes (0):
...
### Community 168 - "Output Match Evaluator"
Cohesion: 0.43
...
### Community 169 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 170 - "Message Char Limit Tests"
Cohesion: 0.33
Nodes (0):

### Community 171 - "Pgaudit Smoke Tests"
Cohesion: 0.6
...
### Community 172 - "OpenAI Streaming Tests"
Cohesion: 0.33
Nodes (0):

### Community 173 - "Graph Memory Maintenance"
Cohesion: 0.33
...
### Community 181 - "Disabled Auth Provider"
Cohesion: 0.4
Nodes (1): DisabledAuthProvider

### Community 182 - "Authz Outbox Tests"
Cohesion: 0.7
...
### Community 183 - "Auth0 Vault Live Tests"
Cohesion: 0.8
Nodes (4): live_auth0_token_vault_returns_third_party_token(), required_env(), required_uuid(), upsert_linked_user()

### Community 184 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0):

### Community 185 - "Fake Clock Test Helper"
Cohesion: 0.4
Nodes (1): FakeClock

### Community 186 - "Neon Branch Maintenance"
Cohesion: 0.4
Nodes (3): NeonMaint, NeonMaintImpl, PruneReport

### Community 187 - "Skill Scope Precedence Tests"
Cohesion: 0.7
...
### Community 188 - "Cohere Live Test"
Cohesion: 0.83
Nodes (3): cohere_embed_v4_returns_1024_dimensional_float_embeddings(), live_cohere_key(), live_cohere_requested()

### Community 189 - "Turbopuffer Live Tests"
Cohesion: 0.83
Nodes (3): basis_vector(), live_store(), turbopuffer_live_round_trip()

### Community 190 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn

### Community 191 - "FGA Bootstrap Live Test"
Cohesion: 0.83
Nodes (3): bootstrap_is_idempotent_across_two_runs(), default_preshared_key_if_unset(), grep_env()

### Community 192 - "Authz Poller Live Test"
Cohesion: 0.83
Nodes (3): fga_from_env(), poller_drains_write_to_fga(), test_pool()

### Community 193 - "JWT Validation Test"
Cohesion: 0.67
Nodes (3): Claims, jwt_validation_accepts_self_signed_auth0_token(), signed_token()

### Community 194 - "Postgres Session Store"
Cohesion: 0.5
Nodes (1): PostgresSessionStore

### Community 195 - "Approval Rule Store"
Cohesion: 0.5
Nodes (1): PostgresSessionStore

### Community 196 - "Cohere Reranker Live Test"
Cohesion: 0.83
Nodes (3): cohere_rerank_v4_fast_prioritizes_relevant_retrieval_candidate(), live_cohere_key(), live_cohere_requested()

### Community 197 - "History Compaction Compile"
Cohesion: 0.83
Nodes (1): HistoryCompiler

### Community 198 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 199 - "Eval Live Tests"
Cohesion: 0.83
Nodes (3): live_model(), live_run_single_produces_eval_result(), test_database_url()

### Community 200 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 201 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 202 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 203 - "Permissions Config"
Cohesion: 0.67
Nodes (1): PermissionsConfig

### Community 204 - "Gateway Config"
Cohesion: 0.67
Nodes (1): GatewayConfig

### Community 205 - "Local Orchestrator Stub"
Cohesion: 0.67
Nodes (1): OrchestratorConfig

### Community 206 - "Builtin Authz Approval Test"
Cohesion: 0.67
Nodes (0):

### Community 207 - "Session Store Helpers"
Cohesion: 0.67
Nodes (1): PostgresSessionStore

### Community 208 - "Shell Chaining Security Test"
Cohesion: 0.67
Nodes (0):

### Community 209 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 210 - "Vector Error Mapping"
Cohesion: 1.0
Nodes (1): moa_core::MoaError

### Community 211 - "Cold Tier Partition Tests"
Cohesion: 1.0
Nodes (0):

### Community 212 - "Memory Scope Test"
Cohesion: 1.0
Nodes (0):

### Community 213 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 214 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 215 - "Audit Security Config"
Cohesion: 1.0
Nodes (1): AuditSecurityConfig

### Community 216 - "OCSF Emit Test"
Cohesion: 1.0
Nodes (0):

### Community 217 - "Serialized Test Guard"
Cohesion: 1.0
Nodes (1): SerializedTest<'a>

### Community 218 - "Lineage Postgres Tests"
Cohesion: 1.0
Nodes (0):

### Community 219 - "Restate Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::Context<'_>

### Community 220 - "Restate Object Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::ObjectContext<'_>

### Community 221 - "Restate Shared Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::SharedObjectContext<'_>

### Community 222 - "Restate Workflow Context Headers"
Cohesion: 1.0
Nodes (1): restate_sdk::context::WorkflowContext<'_>

### Community 223 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 224 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 225 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0):

### Community 226 - "Cache Audit Offline Test"
Cohesion: 1.0
Nodes (0):

### Community 227 - "Live Harness Offline Test"
Cohesion: 1.0
Nodes (0):

### Community 228 - "History Budgeting"
Cohesion: 1.0
Nodes (0):

### Community 229 - "History Error Preservation"
Cohesion: 1.0
Nodes (0):

### Community 230 - "Skills Cache Break"
Cohesion: 1.0
Nodes (0):

### Community 231 - "Workspace Hack Build"
Cohesion: 1.0
Nodes (0):

### Community 232 - "Core Type Macros"
Cohesion: 1.0
Nodes (0):

### Community 233 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0):

### Community 234 - "Restate Registration"
Cohesion: 1.0
Nodes (0):

## Knowledge Gaps
- **867 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `ExpectedFacts`, `ExpectedFact` (+862 more)
...
- **Should `Turn Wire Protocol` be split into smaller, more focused modules?**
  _Cohesion score 0.01 - nodes in this community are weakly interconnected._
- **Should `Skill Frontmatter Format` be split into smaller, more focused modules?**
  _Cohesion score 0.02 - nodes in this community are weakly interconnected._