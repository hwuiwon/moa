...
## Corpus Check
- Large corpus: 393 files · ~309,878 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 5817 nodes · 10325 edges · 181 communities detected
...
Cohesion: 0.02
Nodes (137): ChangelogRecord, validate_scope(), write_and_bump(), EdgeLabel, EdgeWriteIntent, Evaluator, accept_user_message(), append_event() (+129 more)

### Community 1 - "Runtime Events & SSE"
Cohesion: 0.02
Nodes (103): ServiceBridge, ServiceBridgeHandle, ServiceStatus, CatalogIntent, IntentSource, IntentStatus, LearningEntry, TenantIntent (+95 more)

### Community 2 - "Pgvector Store"
Cohesion: 0.02
...
Cohesion: 0.01
Nodes (81): CacheBreakpoint, CacheBreakpointTarget, CacheTtl, completion_stream_abort_stops_completion_task(), CompletionContent, CompletionRequest, CompletionResponse, CompletionStream (+73 more)

### Community 4 - "CLI Entry Point"
Cohesion: 0.02
Nodes (135): AdminCommand, format_promotion_report(), handle_admin_command(), promote_workspace_e2e(), PromoteWorkspaceArgs, WorkspacePromotionArgs, BaseModel, apply_config_update() (+127 more)
...
### Community 25 - "Memory Store Tests"
Cohesion: 0.05
...
### Community 27 - "Query Rewrite Pipeline"
Cohesion: 0.07
...
### Community 28 - "Checkpoint Compaction"
Cohesion: 0.05
...
### Community 30 - "Session Store Service"
Cohesion: 0.05
...
### Community 33 - "Contradiction Detection"
Cohesion: 0.06
...
### Community 36 - "Memory Scope Tool"
Cohesion: 0.05
...
### Community 37 - "Cache Observability"
Cohesion: 0.06
...
### Community 38 - "Daytona Sandbox Provider"
Cohesion: 0.08
...
### Community 41 - "Markdown Stream Healing"
Cohesion: 0.08
...
### Community 43 - "Memory Detail Panel"
Cohesion: 0.07
...
### Community 51 - "MCP Client Discovery"
Cohesion: 0.11
...
Cohesion: 0.11
Nodes (32): apply_decisions(), apply_one_decision(), ApplyOutcome, classifier_from_env(), ClassifierBackend, classify_fact(), classify_facts(), decision_fact() (+24 more)
...
### Community 56 - "Provider Selection & Routing"
Cohesion: 0.11
...
### Community 58 - "Desktop App Shell"
Cohesion: 0.08
...
### Community 64 - "Skill Regression Eval"
Cohesion: 0.11
...
### Community 70 - "Graph Write Protocol"
Cohesion: 0.15
...
### Community 71 - "Live Observability Tests"
Cohesion: 0.11
...
### Community 72 - "Session DB Codecs"
Cohesion: 0.1
...
### Community 74 - "Embedding Provider"
Cohesion: 0.12
...
### Community 77 - "Memory Viewer Panel"
Cohesion: 0.09
...
### Community 79 - "Scripted Test Provider"
Cohesion: 0.14
...
### Community 82 - "Chat Message Bubbles"
Cohesion: 0.17
...
### Community 87 - "Session Postgres Store Tests"
Cohesion: 0.23
...
### Community 88 - "Live Provider Matrix"
Cohesion: 0.25
...
### Community 90 - "Integration Steps 72-77"
Cohesion: 0.19
...
### Community 91 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 92 - "Security Policies"
Cohesion: 0.23
...
### Community 102 - "Prompt Injection Defense"
Cohesion: 0.26
...
### Community 103 - "Query Planner Tests"
Cohesion: 0.15
Nodes (1): SeedGraph

### Community 104 - "Window State Persistence"
Cohesion: 0.28
...
### Community 111 - "Turn Loop Detector"
Cohesion: 0.33
...
### Community 112 - "Intent Classifier"
Cohesion: 0.33
...
### Community 113 - "Session List"
Cohesion: 0.4
Nodes (2): SessionList, SessionSelected

### Community 114 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 115 - "Instruction Stage"
Cohesion: 0.38
...
### Community 119 - "Session VO Tests"
Cohesion: 0.5
...
### Community 128 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 139 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 

### Community 140 - "Legacy Memory Audit"
Cohesion: 0.7
Nodes (4): audit(), contains_legacy_crate_reference(), main(), walk_files()

### Community 141 - "Desktop Status Bar"
Cohesion: 0.5
Nodes (1): MoaStatusBar

### Community 142 - "Event Color Mapping"
Cohesion: 0.6
Nodes (2): event_color(), EventColor

### Community 143 - "Cohere Live Test"
Cohesion: 0.83
Nodes (3): cohere_embed_v4_returns_1024_dimensional_float_embeddings(), live_cohere_key(), live_cohere_requested()

### Community 144 - "Turbopuffer Live Tests"
Cohesion: 0.83
Nodes (3): basis_vector(), live_store(), turbopuffer_live_round_trip()

### Community 145 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn

### Community 146 - "Cohere Reranker Live Test"
Cohesion: 0.83
Nodes (3): cohere_rerank_v4_fast_prioritizes_relevant_retrieval_candidate(), live_cohere_key(), live_cohere_requested()

### Community 147 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 148 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 149 - "Settings Integration Tests"
Cohesion: 0.83
Nodes (3): removing_from_auto_approve_persists(), scratch_dir(), settings_mutations_round_trip_through_config_file()

### Community 150 - "Desktop Title Bar"
Cohesion: 0.67
Nodes (1): MoaTitleBar

### Community 151 - "General Settings Tab"
Cohesion: 0.67
Nodes (2): render_general_tab(), render_model_card()

### Community 152 - "Error Banner Component"
Cohesion: 0.67
Nodes (2): error_banner(), error_banner_any()

### Community 153 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 154 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 155 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 156 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 157 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 158 - "Sidebar Tab Enum"
Cohesion: 0.67
Nodes (1): SidebarTab

### Community 159 - "Permissions Settings Tab"
Cohesion: 1.0
Nodes (2): render_permissions_tab(), tool_list_card()

### Community 160 - "Desktop Service Init"
Cohesion: 0.67
Nodes (1): InitializedServices

### Community 161 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 162 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 163 - "Provider HTTP Client"
Cohesion: 1.0
Nodes (0): 

### Community 164 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0): 

### Community 165 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 166 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 167 - "Agent Adapter"
Cohesion: 1.0
Nodes (1): AgentAdapter

### Community 168 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 169 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 170 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 171 - "Keyboard Shortcuts Tab"
Cohesion: 1.0
Nodes (0): 

### Community 172 - "Icon Button"
Cohesion: 1.0
Nodes (0): 

### Community 173 - "Section Card"
Cohesion: 1.0
Nodes (0): 

### Community 174 - "Segmented Control"
Cohesion: 1.0
Nodes (0): 

### Community 175 - "Markdown Style"
Cohesion: 1.0
Nodes (0): 

### Community 176 - "Nav Item"
Cohesion: 1.0
Nodes (0): 

### Community 177 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 178 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 179 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 180 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **526 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `IngestError`, `SessionTurn` (+521 more)
