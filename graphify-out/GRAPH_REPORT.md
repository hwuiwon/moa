...
## Corpus Check
- 82 files · ~58,882 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1192 nodes · 2008 edges · 56 communities detected
...
### Community 13 - "Wiki & Branching Markdown"
Cohesion: 0.12
...
### Community 17 - "Telegram Renderer"
Cohesion: 0.14
Nodes (14): append_piece(), callback_data_roundtrips(), render_approval_request(), render_diff(), render_tool_card(), renderer_keeps_buttons_on_last_chunk_only(), renderer_splits_long_text_at_telegram_limit(), split_fenced_block() (+6 more)

### Community 18 - "Memory Tools"
Cohesion: 0.08
...
### Community 20 - "FTS5 Search Index"
Cohesion: 0.19
...
### Community 21 - "Session Picker View"
Cohesion: 0.18
...
### Community 22 - "Tool Approval Policies"
Cohesion: 0.22
...
### Community 24 - "Skill Improver & Distiller"
Cohesion: 0.21
...
### Community 26 - "Local Hand Provider"
Cohesion: 0.19
Nodes (2): detect_docker(), LocalHandProvider

### Community 27 - "Memory Maintenance Tests"
Cohesion: 0.29
...
### Community 31 - "History Compilation Stage"
Cohesion: 0.25
...
### Community 32 - "TUI Keybindings"
Cohesion: 0.2
Nodes (1): KeyAction

### Community 33 - "Prompt Widget"
Cohesion: 0.31
Nodes (2): build_textarea(), PromptWidget

### Community 34 - "Session Store Tests"
Cohesion: 0.2
Nodes (0): 

### Community 35 - "Tool Card Widget"
Cohesion: 0.42
Nodes (7): border_line(), content_line(), render_tool_card(), status_label(), status_style(), truncate_to_width(), wrap_text()

### Community 36 - "Memory Store Tests"
Cohesion: 0.43
...
### Community 46 - "File Search Tool"
Cohesion: 0.67
Nodes (3): collect_matches(), execute(), FileSearchInput

### Community 47 - "File Read Tool"
Cohesion: 0.67
Nodes (3): execute(), FileReadInput, resolve_sandbox_path()

### Community 48 - "Chat Harness Example"
Cohesion: 0.83
Nodes (3): main(), resolve_session_db_path(), run_prompt()

### Community 49 - "Anthropic Provider Tests"
Cohesion: 0.67
Nodes (0): 

### Community 50 - "File Write Tool"
Cohesion: 0.67
Nodes (1): FileWriteInput

### Community 51 - "Anthropic Live Test"
Cohesion: 1.0
Nodes (0): 

### Community 52 - "Compaction"
Cohesion: 1.0
Nodes (0): 

### Community 53 - "Search Query Extraction"
Cohesion: 1.0
Nodes (2): extract_search_keywords (stopword filter), extract_search_query

### Community 54 - "Live Brain Turn Test"
Cohesion: 1.0
Nodes (1): live_brain_turn_returns_brain_response test

### Community 55 - "Relevant Memory Page"
Cohesion: 1.0
Nodes (1): RelevantMemoryPage

## Knowledge Gaps
- **139 isolated node(s):** `LogChange`, `LogEntry`, `IngestReport`, `PageFrontmatter`, `ChangeOperation` (+134 more)
