...
## Corpus Check
- 115 files · ~98,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2016 nodes · 3575 edges · 79 communities detected
...
9. `E2BHandProvider` - 19 edges
10. `DaytonaHandProvider` - 18 edges
...
### Community 3 - "Tool Router & Policies"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (27): MoaError, canary_detection_works(), check_canary(), classifier_flags_known_attack_patterns(), classify_input(), contains_canary_tokens(), inject_canary(), InputClassification (+19 more)
...
### Community 15 - "Telegram Renderer"
Cohesion: 0.09
...
### Community 21 - "E2B Hand Provider"
Cohesion: 0.14
...
### Community 23 - "CLI Entry Point"
Cohesion: 0.09
Nodes (25): apply_config_update(), Cli, CommandKind, config_updates_known_keys(), ConfigCommand, current_workspace_id(), DaemonCommand, disk_status() (+17 more)
...
Cohesion: 0.16
Nodes (28): daemon_info(), daemon_lists_session_previews(), daemon_log_path(), daemon_logs(), daemon_pid_path(), daemon_ping_create_and_shutdown_roundtrip(), daemon_socket_path(), DaemonCommand (+20 more)

### Community 27 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 28 - "Daytona Hand Provider"
Cohesion: 0.18
...
### Community 31 - "Approval Card Widget"
Cohesion: 0.13
...
### Community 32 - "Brain Turn Streaming"
Cohesion: 0.13
...
### Community 38 - "Daytona Live Tests"
Cohesion: 0.18
...
### Community 39 - "Memory Maintenance Tests"
Cohesion: 0.29
...
### Community 47 - "TUI Keybindings"
Cohesion: 0.17
Nodes (1): KeyAction

### Community 48 - "Toolbar Widget"
Cohesion: 0.24
...
### Community 49 - "Live Provider Roundtrip Tests"
Cohesion: 0.3
...
### Community 50 - "History Compilation Stage"
Cohesion: 0.25
