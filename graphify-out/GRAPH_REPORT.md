...
## Corpus Check
- Large corpus: 263 files · ~227,909 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 4133 nodes · 7240 edges · 153 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `PostgresSessionStore` - 39 edges
2. `LocalChatRuntime` - 36 edges
3. `DaemonChatRuntime` - 35 edges
4. `SkillFrontmatter` - 33 edges
5. `FileMemoryStore` - 31 edges
6. `start_session()` - 28 edges
7. `LocalOrchestrator` - 27 edges
8. `session()` - 26 edges
9. `WikiSearchIndex` - 21 edges
10. `LocalHandProvider` - 21 edges
...
- **Live E2E Provider Test Matrix** — live_e2e_openai_doc, live_e2e_anthropic_doc, live_e2e_google_doc, live_e2e_testing_concept [INFERRED 0.80]
- **Multi-Provider Abstraction Flow** — openai_provider_concept, anthropic_provider_concept, google_provider_concept, model_provider_abstraction [INFERRED 0.70]
...
Cohesion: 0.02
Nodes (60): ServiceBridge, ServiceBridgeHandle, ServiceStatus, build_default_pipeline(), build_default_pipeline_with_runtime(), build_default_pipeline_with_runtime_and_instructions(), build_default_pipeline_with_tools(), cache_prefix_ratio() (+52 more)

### Community 1 - "Core Errors & Traits"
Cohesion: 0.02
Nodes (62): lag_counter(), lag_counter_by_channel(), record_broadcast_lag(), recv_with_lag_handling(), RecvResult, EvalError, MoaError, approval_requested_event_round_trips_full_prompt() (+54 more)

### Community 2 - "Local Orchestrator Tests"
Cohesion: 0.05
Nodes (69): Inspectability Over Magic, History-First Observation Semantics, approval_requested_event_persists_full_prompt_details(), blank_session_waits_for_first_message(), collect_runtime_events_until(), completed_tool_turn_destroys_cached_hand(), create_test_store(), CurrentDirGuard (+61 more)
...
Cohesion: 0.04
Nodes (51): cache_optimizer_plans_tool_static_and_conversation_breakpoints(), cache_optimizer_skips_conversation_breakpoint_for_short_sessions(), CacheOptimizer, history_end_index(), latest_conversation_cache_candidate(), place_bp4_conversation(), plan_cache_controls(), replan_on_lookback_overflow() (+43 more)
...
Cohesion: 0.04
Nodes (51): bash_output_small_streams_are_not_truncated(), bash_output_truncates_with_head_and_tail_preserved(), BashToolInput, build_bash_output(), execute_docker(), execute_local(), truncate_shell_stream(), batcher_holds_events_until_interval_elapses() (+43 more)
...
### Community 20 - "Wiki Search Index"
Cohesion: 0.08
...
### Community 21 - "Memory Detail Panel"
Cohesion: 0.06
...
### Community 24 - "Temporal Orchestrator"
Cohesion: 0.06
...
### Community 27 - "Turn Streaming & Approval"
Cohesion: 0.05
...
### Community 29 - "Markdown Stream Healing"
Cohesion: 0.08
...
### Community 30 - "Skill Injection Stage"
Cohesion: 0.08
...
### Community 31 - "Local Tool Tests"
Cohesion: 0.07
Nodes (30): approval_prompt_str_replace_diff_is_surgical(), approval_prompt_uses_remembered_workspace_root_for_commands(), bash_captures_stdout_and_stderr(), bash_respects_timeout(), EmptyMemoryStore, file_operations_reject_path_traversal(), file_read_reads_written_content(), file_search_finds_files_by_glob() (+22 more)

### Community 32 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 33 - "Memory Consolidation"
Cohesion: 0.08
...
### Community 35 - "Gateway Message Renderer"
Cohesion: 0.09
...
### Community 52 - "Daytona Sandbox Provider"
Cohesion: 0.17
...
### Community 53 - "Live Cache Audit Tests"
Cohesion: 0.14
...
### Community 54 - "Command Palette & Keybindings"
Cohesion: 0.12
...
### Community 60 - "Embedding Provider"
Cohesion: 0.12
...
### Community 61 - "Memory Store Tests"
Cohesion: 0.21
...
### Community 62 - "Session Blob Store"
Cohesion: 0.18
...
### Community 63 - "Tool Approval Policies"
Cohesion: 0.16
...
### Community 66 - "Scripted Test Provider"
Cohesion: 0.14
Nodes (3): ScriptedBlock, ScriptedProvider, ScriptedResponse

### Community 67 - "Runtime Context Stage"
Cohesion: 0.19
...
### Community 68 - "Workspace Discovery"
Cohesion: 0.13
...
### Community 69 - "Telemetry & Observability"
Cohesion: 0.15
...
### Community 71 - "Chat Message Bubbles"
Cohesion: 0.17
...
### Community 73 - "Cache Observability"
Cohesion: 0.18
...
### Community 75 - "Schema Migrations"
Cohesion: 0.2
...
### Community 76 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 77 - "Settings Panel"
Cohesion: 0.19
Nodes (3): SettingsDismissed, SettingsPage, SettingsSection

### Community 78 - "Memory Bootstrap"
Cohesion: 0.24
...
### Community 80 - "Tool Router Construction"
Cohesion: 0.18
Nodes (2): default_cloud_provider(), ToolRouter

### Community 81 - "Session Row Badges"
Cohesion: 0.2
...
### Community 82 - "HTTP Retry Policy"
Cohesion: 0.27
...
### Community 85 - "Window State Persistence"
Cohesion: 0.28
...
### Community 89 - "Turn Loop Detector"
Cohesion: 0.33
...
### Community 90 - "Session List"
Cohesion: 0.4
Nodes (2): SessionList, SessionSelected

### Community 91 - "Instruction Stage"
Cohesion: 0.38
...
### Community 92 - "Session Sidebar"
Cohesion: 0.24
Nodes (1): SessionSidebar

### Community 93 - "Session Summarizer Prompt"
Cohesion: 0.22
...
### Community 96 - "Temporal Worker Helper"
Cohesion: 0.32
Nodes (4): helper_config(), HelperProvider, main(), main_impl()

### Community 97 - "WCAG Contrast Helpers"
Cohesion: 0.39
Nodes (6): black_on_white_is_max_ratio(), classify(), contrast_ratio(), equal_colors_are_ratio_one(), relative_luminance(), WcagPass

### Community 98 - "Live E2E Test Fixtures"
Cohesion: 0.46
Nodes (8): Anthropic Provider, Google Provider, LIVE-E2E-ANTHROPIC, LIVE-E2E-GOOGLE, LIVE-E2E-OPENAI, Live End-to-End Testing, Multi-Provider Model Abstraction, OpenAI Provider
...
### Community 108 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 

### Community 109 - "Desktop Status Bar"
Cohesion: 0.5
Nodes (1): MoaStatusBar

### Community 110 - "Event Color Mapping"
Cohesion: 0.6
Nodes (2): event_color(), EventColor

### Community 111 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 112 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 113 - "Settings Integration Tests"
Cohesion: 0.83
Nodes (3): removing_from_auto_approve_persists(), scratch_dir(), settings_mutations_round_trip_through_config_file()

### Community 114 - "Desktop Title Bar"
Cohesion: 0.67
Nodes (1): MoaTitleBar

### Community 115 - "General Settings Tab"
Cohesion: 0.67
Nodes (2): render_general_tab(), render_model_card()

### Community 116 - "Error Banner Component"
Cohesion: 0.67
Nodes (2): error_banner(), error_banner_any()

### Community 117 - "Architecture Doc Hub"
Cohesion: 0.67
Nodes (4): MOA Architecture Document, Design Values, MOA README, MOA Sequence Diagrams

### Community 118 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 119 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 120 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 121 - "Sidebar Tab Enum"
Cohesion: 0.67
Nodes (1): SidebarTab

### Community 122 - "Permissions Settings Tab"
Cohesion: 1.0
Nodes (2): render_permissions_tab(), tool_list_card()

### Community 123 - "Desktop Service Init"
Cohesion: 0.67
...
### Community 125 - "architecture.md"
Cohesion: 0.67
Nodes (3): Cache Breakpoint Boundary, Progressive Disclosure of Skills, Stable Prefix KV-Cache Optimization

### Community 126 - "Credential Isolation"
Cohesion: 0.67
Nodes (3): Credential Isolation / Proxy, Prompt Injection Defense in Depth, §14 Credential Proxy

### Community 127 - "Compaction Architecture"
Cohesion: 0.67
Nodes (3): Two-Phase Compaction (Memory Flush + Checkpoint), Dream Consolidation Cron, §7 Compaction Dance

### Community 128 - "Three-Tier Approvals"
Cohesion: 0.67
Nodes (3): Reversible Collaboration, Three-Tier Approval Model, §4 Three-Tier Approval Flow

### Community 129 - "sequence-diagrams.md"
Cohesion: 0.67
Nodes (3): 7-Stage Context Compilation Pipeline, §1 Full E2E Flow (mermaid), §3 Pipeline Stages (mermaid)

### Community 130 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 131 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 132 - "Provider HTTP Client"
Cohesion: 1.0
Nodes (0): 

### Community 133 - "moa-orchestrator"
Cohesion: 1.0
Nodes (0): 

### Community 134 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 135 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 136 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 137 - "Keyboard Shortcuts Tab"
Cohesion: 1.0
Nodes (0): 

### Community 138 - "Icon Button"
Cohesion: 1.0
Nodes (0): 

### Community 139 - "Section Card"
Cohesion: 1.0
Nodes (0): 

### Community 140 - "Segmented Control"
Cohesion: 1.0
Nodes (0): 

### Community 141 - "Settings Row"
Cohesion: 1.0
Nodes (0): 

### Community 142 - "Markdown Style"
Cohesion: 1.0
Nodes (0): 

### Community 143 - "Nav Item"
Cohesion: 1.0
Nodes (0): 

### Community 144 - "Many Brains, Many Hands"
Cohesion: 1.0
Nodes (2): Hands are Cattle, Not Pets, Many Brains, Many Hands

### Community 145 - "Concurrent Memory Writes"
Cohesion: 1.0
Nodes (2): Git-Branch Concurrent Memory Writes, §12 Concurrent Memory Writes

### Community 146 - "History Replay Regressions"
Cohesion: 1.0
Nodes (2): Errors Always Preserved Through Compaction, Proptest History Regression Seeds

### Community 147 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 148 - "Sandbox Tiers"
Cohesion: 1.0
Nodes (1): Sandbox Tiers (0/1/2)

### Community 149 - "Command Approval Matching"
Cohesion: 1.0
Nodes (1): Parsed-Command-Level Approval Matching

### Community 150 - "Temporal Idempotency"
Cohesion: 1.0
Nodes (1): Temporal Idempotency (UNIQUE session_id, sequence_num)

### Community 151 - "File-Backed Wiki Memory"
Cohesion: 1.0
Nodes (1): File-Backed Wiki Memory

### Community 152 - "History Regression Seeds"
Cohesion: 1.0
...
- `LIVE-E2E-OPENAI` → `Multi-Provider Model Abstraction`  [AMBIGUOUS]
  live/openai.txt · relation: rationale_for
- `Multi-Provider Model Abstraction` → `LIVE-E2E-ANTHROPIC`  [AMBIGUOUS]
  live/anthropic.txt · relation: rationale_for
- `Multi-Provider Model Abstraction` → `LIVE-E2E-GOOGLE`  [AMBIGUOUS]
  live/google.txt · relation: rationale_for

## Knowledge Gaps
- **382 isolated node(s):** `LogChange`, `LogEntry`, `BootstrapReport`, `BootstrapSentinel`, `PageFrontmatter` (+377 more)
...
- **What is the exact relationship between `LIVE-E2E-OPENAI` and `Multi-Provider Model Abstraction`?**
  _Edge tagged AMBIGUOUS (relation: rationale_for) - confidence is low._
- **What is the exact relationship between `Multi-Provider Model Abstraction` and `LIVE-E2E-ANTHROPIC`?**
  _Edge tagged AMBIGUOUS (relation: rationale_for) - confidence is low._
- **What is the exact relationship between `Multi-Provider Model Abstraction` and `LIVE-E2E-GOOGLE`?**
  _Edge tagged AMBIGUOUS (relation: rationale_for) - confidence is low._
