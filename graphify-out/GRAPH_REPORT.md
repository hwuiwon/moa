...
## Corpus Check
- Large corpus: 361 files · ~299,924 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 5799 nodes · 10359 edges · 164 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `PostgresSessionStore` - 72 edges
...
Cohesion: 0.02
Nodes (130): ChangelogRecord, validate_scope(), write_and_bump(), EdgeLabel, EdgeWriteIntent, Evaluator, LineageRecordId, TurnId (+122 more)

### Community 1 - "Core Errors & Traits"
Cohesion: 0.01
Nodes (109): AdapterError, answer_span_bytes(), anthropic_adapter_maps_document_index(), anthropic_chunk(), AnthropicCitations, cascade_flags_vendor_hallucinated_citation(), ChunkRef, chunks() (+101 more)

### Community 2 - "Runtime Events & SSE"
Cohesion: 0.02
...
Cohesion: 0.02
Nodes (156): AdminCommand, format_promotion_report(), handle_admin_command(), promote_workspace_e2e(), PromoteWorkspaceArgs, WorkspacePromotionArgs, BaseModel, apply_config_update() (+148 more)

### Community 4 - "Pgvector Store"
Cohesion: 0.02
Nodes (106): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), AgTypeParam, Cypher (+98 more)
...
Cohesion: 0.02
Nodes (58): budget_config_defaults_are_applied(), BudgetConfig, CloudConfig, CloudFlyioConfig, CloudHandsConfig, CohereEmbedderConfig, compaction_config_defaults_are_applied(), CompactionConfig (+50 more)

### Community 9 - "Postgres Session Store"
Cohesion: 0.04
Nodes (31): backfill_from(), listen_stream_backfills_from_last_seen_sequence(), listen_stream_receives_cross_store_events_in_order(), NotifyPayload, rolled_back_notify_is_not_observed(), run_listener_task(), seed_session(), session_channel_name() (+23 more)

### Community 10 - "Session Store Service"
Cohesion: 0.03
Nodes (55): append_event_increments_sequence(), AppendEventRequest, cleanup(), CompleteSegmentRequest, CreateSegmentRequest, get_events_respects_range(), GetEventsRequest, GetSegmentBaselineRequest (+47 more)

### Community 11 - "Gemini Provider"
Cohesion: 0.04
Nodes (69): build_cache_create_body(), build_contents_from_messages(), build_embedder_from_config(), build_explicit_cache_plan(), build_generation_config(), build_request_body(), build_request_body_from_parts(), build_request_parts() (+61 more)
...
### Community 16 - "Privacy Export & Erase"
Cohesion: 0.06
...
### Community 19 - "Local Chat Runtime"
Cohesion: 0.04
...
### Community 28 - "Tool Types & Policy"
Cohesion: 0.04
...
### Community 29 - "Cohere Reranker Live Test"
Cohesion: 0.06
...
### Community 30 - "Memory Scope Tool"
Cohesion: 0.05
Nodes (21): contribution(), duration_ms_u32(), extract_search_keywords(), extract_search_query(), extract_search_query_from_messages(), fast_memory_policy(), graph_hit_excerpt(), GraphMemoryRetriever (+13 more)

### Community 31 - "OpenAI Responses Provider"
Cohesion: 0.06
...
### Community 33 - "Turn Streaming & Approvals"
Cohesion: 0.05
Nodes (37): build_turn_context(), BuildTurnContextOptions, persist_context_snapshot(), context_chunk(), drain_signal_queue(), emit_context_lineage(), emit_generation_lineage(), estimate_tokens() (+29 more)
...
### Community 38 - "Workspace Instructions"
Cohesion: 0.07
...
### Community 39 - "Cache Observability"
Cohesion: 0.06
...
### Community 40 - "Daytona Sandbox Provider"
Cohesion: 0.08
...
### Community 41 - "Fact Extraction & SSE"
Cohesion: 0.06
...
### Community 42 - "Query Planner & NER"
Cohesion: 0.07
...
### Community 43 - "Lineage MPSC Sink Writer"
Cohesion: 0.07
...
### Community 47 - "E2B Sandbox Provider"
Cohesion: 0.12
...
### Community 48 - "Pgvector Store Tests"
Cohesion: 0.08
Nodes (25): assert_replay_flattening(), assert_turn_latency_spans(), build_auth_source(), build_scripted_provider(), cached_usage(), collect_cache_control_ttls(), collect_tool_runs(), extend_tool_schemas() (+17 more)

### Community 49 - "Gateway Message Renderer"
Cohesion: 0.09
...
### Community 62 - "Live Ingestion E2E"
Cohesion: 0.14
...
### Community 70 - "Session DB Codecs"
Cohesion: 0.1
...
### Community 72 - "Lineage Records & Stages"
Cohesion: 0.07
Nodes (22): AgeIntrospection, BackendIntrospection, Citation, CitationLineage, ContextChunk, ContextLineage, FusedHit, GenerationLineage (+14 more)

### Community 73 - "Telegram Adapter"
Cohesion: 0.16
...
### Community 74 - "Citation Verifiers"
Cohesion: 0.13
...
### Community 78 - "Scripted Test Provider"
Cohesion: 0.14
Nodes (3): ScriptedBlock, ScriptedProvider, ScriptedResponse

### Community 79 - "Runtime Context Stage"
Cohesion: 0.19
...
### Community 80 - "Session Analytics"
Cohesion: 0.15
...
### Community 81 - "OpenAI Privacy Filter"
Cohesion: 0.14
...
### Community 83 - "Session Postgres Store Tests"
Cohesion: 0.23
...
### Community 87 - "Tool Router Construction"
Cohesion: 0.14
Nodes (2): default_cloud_provider(), ToolRouter

### Community 88 - "CLI Exec Command"
Cohesion: 0.15
...
### Community 89 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 90 - "Security Policies"
Cohesion: 0.23
...
### Community 98 - "Prometheus Metrics Tests"
Cohesion: 0.23
...
### Community 99 - "Neon Branch Manager Tests"
Cohesion: 0.32
...
### Community 101 - "Query Planner Tests"
Cohesion: 0.15
Nodes (1): SeedGraph

### Community 102 - "Ingest Runtime Context"
Cohesion: 0.2
...
### Community 107 - "Cold Tier Exporter"
Cohesion: 0.27
Nodes (5): ColdTierConfig, ColdTierExporter, ExporterStats, partition_key(), render_parquet_rows()

### Community 108 - "Turn Loop Detector"
Cohesion: 0.33
...
### Community 109 - "Intent Classifier"
Cohesion: 0.33
...
### Community 112 - "Provider Model Catalog"
Cohesion: 0.29
...
### Community 113 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 114 - "Instruction Stage"
Cohesion: 0.38
...
### Community 118 - "Session VO Tests"
Cohesion: 0.5
...
### Community 127 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 136 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 

### Community 137 - "Cohere Live Test"
Cohesion: 0.83
Nodes (3): cohere_embed_v4_returns_1024_dimensional_float_embeddings(), live_cohere_key(), live_cohere_requested()

### Community 138 - "Turbopuffer Live Tests"
Cohesion: 0.83
Nodes (3): basis_vector(), live_store(), turbopuffer_live_round_trip()

### Community 139 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn

### Community 140 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 141 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 142 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 143 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 144 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 145 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 146 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 147 - "Perf Gate Binary"
Cohesion: 0.67
Nodes (1): Args

### Community 148 - "Cold Tier Partition Tests"
Cohesion: 1.0
Nodes (0): 

### Community 149 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 150 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 151 - "Provider HTTP Client"
Cohesion: 1.0
Nodes (0): 

### Community 152 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0): 

### Community 153 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 154 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 155 - "Agent Adapter"
Cohesion: 1.0
Nodes (1): AgentAdapter

### Community 156 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 157 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 158 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 159 - "Perf Gate Config"
Cohesion: 1.0
Nodes (1): PerfGateConfig

### Community 160 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 161 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 162 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 163 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **567 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `IngestError`, `SessionTurn` (+562 more)
