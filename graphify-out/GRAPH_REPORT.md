...
## Corpus Check
- 112 files · ~92,658 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1872 nodes · 3304 edges · 79 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `App` - 69 edges
2. `ChatRuntime` - 31 edges
3. `SkillFrontmatter` - 30 edges
4. `FileMemoryStore` - 26 edges
5. `LocalOrchestrator` - 21 edges
6. `MemoryViewState` - 20 edges
7. `E2BHandProvider` - 19 edges
8. `DaytonaHandProvider` - 18 edges
9. `ToolRouter` - 17 edges
10. `TursoSessionStore` - 16 edges
...
Cohesion: 0.06
Nodes (33): App, app_state_transitions_follow_idle_composing_running_waiting_idle(), AppMode, approval_status_and_note(), ApprovalCardStatus, ApprovalEntry, ChatEntry, collect_sandbox_files() (+25 more)

### Community 2 - "Tool Router & Policies"
Cohesion: 0.05
...
### Community 4 - "Local Orchestrator"
Cohesion: 0.07
...
### Community 8 - "Memory Browser View"
Cohesion: 0.05
...
### Community 11 - "Anthropic Provider"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (9): ChatRuntime, expand_local_path(), last_session_message(), local_user_id(), relay_runtime_events(), relay_session_runtime_events(), SessionPreview, SessionRuntimeEvent (+1 more)

### Community 13 - "Telegram Renderer"
Cohesion: 0.09
...
### Community 15 - "Temporal Orchestrator Tests"
Cohesion: 0.11
...
### Community 20 - "E2B Hand Provider"
Cohesion: 0.14
...
### Community 22 - "Wiki & Branching Markdown"
Cohesion: 0.12
...
### Community 24 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 25 - "Daytona Hand Provider"
Cohesion: 0.18
...
### Community 29 - "Approval Card Widget"
Cohesion: 0.13
...
### Community 30 - "Brain Turn Streaming"
Cohesion: 0.13
...
### Community 31 - "Memory Consolidation"
Cohesion: 0.19
...
### Community 38 - "Memory Maintenance Tests"
Cohesion: 0.29
...
### Community 40 - "OpenAI Provider Tests"
Cohesion: 0.25
...
### Community 45 - "Prompt Injection Defense"
Cohesion: 0.26
...
### Community 46 - "TUI Keybindings"
Cohesion: 0.17
Nodes (1): KeyAction

### Community 47 - "Toolbar Widget"
Cohesion: 0.24
...
### Community 48 - "Live Provider Roundtrip Tests"
Cohesion: 0.3
...
### Community 49 - "History Compilation Stage"
Cohesion: 0.25
...
### Community 64 - "Memory Preload Stage"
Cohesion: 0.5
...
### Community 77 - "Search Query Extraction"
Cohesion: 1.0
Nodes (2): extract_search_keywords (stopword filter), extract_search_query

### Community 78 - "Relevant Memory Page"
Cohesion: 1.0
Nodes (1): RelevantMemoryPage

## Knowledge Gaps
- **175 isolated node(s):** `LogChange`, `LogEntry`, `IngestReport`, `PageFrontmatter`, `ChangeOperation` (+170 more)
