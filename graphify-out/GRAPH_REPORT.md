...
## Corpus Check
- 152 files · ~138,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2748 nodes · 4879 edges · 89 communities detected
...
Cohesion: 0.03
Nodes (49): CloudConfig, CloudFlyioConfig, CloudHandsConfig, CloudTemporalConfig, config_loads_from_file(), config_rejects_zero_neon_checkpoint_limit_when_enabled(), DaemonConfig, DatabaseBackend (+41 more)

### Community 5 - "E2B Live Tests"
Cohesion: 0.03
Nodes (40): CollectedExecution, collector_tracks_tool_steps_and_metrics(), estimate_cost(), TrajectoryCollector, truncate(), destroy_and_wait(), e2b_live_provider_handles_roundtrip_and_lifecycle(), e2b_live_router_lazy_provisions_reuses_and_isolates_sessions() (+32 more)
...
### Community 20 - "Memory Consolidation"
Cohesion: 0.08
...
### Community 21 - "Brain Turn Execution"
Cohesion: 0.09
...
### Community 27 - "E2B Sandbox Provider"
Cohesion: 0.14
...
### Community 29 - "Pipeline & Session Helpers"
Cohesion: 0.1
Nodes (17): build_default_pipeline(), build_default_pipeline_with_tools(), cache_prefix_ratio(), ContextPipeline, estimate_tokens(), EvaluatorOptions, pipeline_runner_executes_stages_in_order(), PipelineStageReport (+9 more)

### Community 30 - "Eval Execution Engine"
Cohesion: 0.12
...
### Community 31 - "Wiki & Memory Branching"
Cohesion: 0.12
...
### Community 34 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 35 - "Daytona Workspace Provider"
Cohesion: 0.17
...
### Community 38 - "Docker File Operations"
Cohesion: 0.11
...
### Community 39 - "Skill Injection Stage"
Cohesion: 0.11
...
### Community 40 - "History Compilation Stage"
Cohesion: 0.12
...
### Community 41 - "Approval Card Widget"
Cohesion: 0.13
...
### Community 42 - "LLM Span Instrumentation"
Cohesion: 0.15
...
### Community 44 - "Session Database Backend"
Cohesion: 0.1
...
### Community 47 - "Session Picker View"
Cohesion: 0.18
...
### Community 48 - "Tool Approval Policies"
Cohesion: 0.22
...
### Community 50 - "Daytona Live Tests"
Cohesion: 0.18
...
## Knowledge Gaps
- **227 isolated node(s):** `LogChange`, `LogEntry`, `IngestReport`, `PageFrontmatter`, `ChangeOperation` (+222 more)
