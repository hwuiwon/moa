...
## Corpus Check
- 127 files · ~121,174 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2423 nodes · 4277 edges · 86 communities detected
...
Cohesion: 0.04
Nodes (50): append_change_manifest(), branch_dir(), branch_file_path(), branch_root(), ChangeOperation, ChangeRecord, list_branches(), merge_markdown() (+42 more)
...
Cohesion: 0.05
Nodes (23): CloudConfig, CloudFlyioConfig, CloudHandsConfig, CloudTemporalConfig, config_loads_from_file(), config_rejects_zero_neon_checkpoint_limit_when_enabled(), DaemonConfig, DatabaseBackend (+15 more)
...
Cohesion: 0.07
Nodes (38): apply_config_update(), checkpoint_cleanup_report(), checkpoint_create_report(), checkpoint_list_report(), checkpoint_rollback_report(), CheckpointCommand, Cli, cloud_sync_status() (+30 more)

### Community 19 - "Daemon Service"
Cohesion: 0.12
...
### Community 21 - "Temporal Orchestrator Tests"
Cohesion: 0.11
...
### Community 22 - "Brain Turn Execution"
Cohesion: 0.1
...
### Community 29 - "Daytona Workspace Provider"
Cohesion: 0.17
...
### Community 41 - "Session Picker View"
Cohesion: 0.18
...
### Community 42 - "Tool Approval Policies"
Cohesion: 0.22
...
### Community 43 - "Skill Improver & Distiller"
Cohesion: 0.21
...
### Community 55 - "Prompt Injection Detection"
Cohesion: 0.26
...
## Knowledge Gaps
- **197 isolated node(s):** `LogChange`, `LogEntry`, `IngestReport`, `PageFrontmatter`, `ChangeOperation` (+192 more)
