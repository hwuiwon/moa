...
## Corpus Check
- 98 files · ~79,173 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1607 nodes · 2797 edges · 68 communities detected
...
Cohesion: 0.06
Nodes (28): emit_tool_output_warning(), execute_pending_tool(), format_tool_output(), process_resolved_approval(), run_brain_turn(), run_brain_turn_with_tools(), run_brain_turn_with_tools_mode(), run_brain_turn_with_tools_stepwise() (+20 more)
...
### Community 7 - "Temporal Orchestrator"
Cohesion: 0.06
...
### Community 10 - "Telegram Renderer"
Cohesion: 0.09
...
### Community 16 - "E2B Hand Provider"
Cohesion: 0.14
...
### Community 19 - "Wiki & Branching Markdown"
Cohesion: 0.12
...
### Community 22 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 23 - "Daytona Hand Provider"
Cohesion: 0.18
...
### Community 29 - "FTS5 Search Index"
Cohesion: 0.19
...
### Community 30 - "Session Picker View"
Cohesion: 0.18
...
### Community 31 - "Tool Approval Policies"
Cohesion: 0.22
...
### Community 32 - "Skill Improver & Distiller"
Cohesion: 0.21
...
### Community 34 - "Daytona Live Tests"
Cohesion: 0.18
...
### Community 35 - "Memory Maintenance Tests"
Cohesion: 0.29
...
### Community 42 - "History Compilation Stage"
Cohesion: 0.25
...
### Community 57 - "File Read Tool"
Cohesion: 0.67
Nodes (3): execute(), FileReadInput, resolve_sandbox_path()

### Community 58 - "Chat Harness Example"
Cohesion: 0.83
Nodes (3): main(), resolve_session_db_path(), run_prompt()

### Community 59 - "Anthropic Provider Tests"
Cohesion: 0.67
Nodes (0): 

### Community 60 - "Mock MCP Server"
Cohesion: 0.67
Nodes (0): 

### Community 61 - "File Write Tool"
Cohesion: 0.67
Nodes (1): FileWriteInput

### Community 62 - "Anthropic Live Test"
Cohesion: 1.0
Nodes (0): 

### Community 63 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 64 - "Compaction"
Cohesion: 1.0
Nodes (0): 

### Community 65 - "Search Query Extraction"
Cohesion: 1.0
Nodes (2): extract_search_keywords (stopword filter), extract_search_query

### Community 66 - "Live Brain Turn Test"
Cohesion: 1.0
Nodes (1): live_brain_turn_returns_brain_response test

### Community 67 - "Relevant Memory Page"
Cohesion: 1.0
Nodes (1): RelevantMemoryPage

## Knowledge Gaps
- **167 isolated node(s):** `LogChange`, `LogEntry`, `IngestReport`, `PageFrontmatter`, `ChangeOperation` (+162 more)
