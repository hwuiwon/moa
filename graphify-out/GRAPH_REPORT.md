...
## Corpus Check
- Large corpus: 245 files · ~193,033 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 3539 nodes · 6008 edges · 133 communities detected
...
Cohesion: 0.02
Nodes (64): ServiceBridge, ServiceBridgeHandle, ServiceStatus, group_by_type(), hash_path(), MemoryList, MemoryPageSelected, type_badge() (+56 more)

### Community 1 - "Event Stream & Tokens"
Cohesion: 0.02
Nodes (65): EvalError, MoaError, approval_requested_event_round_trips_full_prompt(), Event, sample_approval_prompt(), ClaimCheck, event_stream_reports_lagged_broadcasts(), EventFilter (+57 more)

### Community 2 - "Live Provider Matrix"
Cohesion: 0.03
Nodes (50): CollectedExecution, collector_tracks_tool_steps_and_metrics(), estimate_cost(), TrajectoryCollector, truncate(), daytona_live_provider_handles_roundtrip_and_lifecycle(), daytona_live_router_lazy_provisions_reuses_and_isolates_sessions(), destroy_and_wait() (+42 more)
...
### Community 6 - "Memory Types & Scopes"
Cohesion: 0.03
...
Cohesion: 0.06
Nodes (33): accept_user_message(), append_event(), append_pause_summary(), best_effort_resolve_pending_signal(), collect_turn_tool_summaries(), detect_docker(), detect_workspace_path(), docker_status() (+25 more)

### Community 8 - "Exec Command Flow"
Cohesion: 0.05
Nodes (40): bash_output_small_streams_are_not_truncated(), bash_output_truncates_with_head_and_tail_preserved(), BashToolInput, build_bash_output(), execute_docker(), execute_local(), truncate_shell_stream(), batcher_holds_events_until_interval_elapses() (+32 more)
...
Cohesion: 0.07
Nodes (35): build_full_file_read_path_map(), capabilities(), compacted_view_preserves_old_errors_and_respects_budget(), compaction_triggers_at_threshold_and_keeps_full_log(), compile_records(), CompiledHistory, CompiledRecordMessage, compiler_with_recent_turns() (+27 more)

### Community 15 - "Tool Types & Policy"
Cohesion: 0.05
...
### Community 21 - "Markdown Stream Healing"
Cohesion: 0.08
...
### Community 24 - "Skill Regression Testing"
Cohesion: 0.07
...
### Community 25 - "Desktop Design Docs"
Cohesion: 0.05
...
### Community 26 - "Turn Streaming & Approval"
Cohesion: 0.06
...
### Community 27 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 30 - "Adaptive Tool Stats"
Cohesion: 0.1
...
### Community 41 - "Working Context Messages"
Cohesion: 0.09
...
### Community 43 - "Wiki & Memory Branching"
Cohesion: 0.12
...
### Community 44 - "Tool Router Policy"
Cohesion: 0.09
...
### Community 47 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 48 - "Command Palette & Keybindings"
Cohesion: 0.12
...
### Community 50 - "Session State Types"
Cohesion: 0.09
...
### Community 51 - "Session Store Tests"
Cohesion: 0.13
...
### Community 53 - "Session Database Dispatch"
Cohesion: 0.09
...
### Community 59 - "Telemetry & Observability"
Cohesion: 0.16
...
### Community 63 - "File Outline Tool"
Cohesion: 0.19
...
### Community 64 - "Workspace Instruction Discovery"
Cohesion: 0.14
...
### Community 65 - "CallViewSet Task Plan"
Cohesion: 0.15
...
### Community 66 - "Memory Maintenance Tests"
Cohesion: 0.27
...
### Community 67 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 74 - "Prompt Injection Detection"
Cohesion: 0.26
...
### Community 82 - "Postgres Store Tests"
Cohesion: 0.36
...
### Community 102 - "Chat Harness Example"
Cohesion: 0.83
...
### Community 109 - "Retest Plan Overview"
Cohesion: 1.0
Nodes (4): Applied Retest Plan, Live Retest Findings, Progress Tracker, Task Plan: CallViewSet Retest

### Community 110 - "Applied Workspace Harness"
Cohesion: 0.5
Nodes (4): Applied workspace (~/github/applied), CallViewSet refactor task, Live Run Command, E2E Preconditions

### Community 111 - "Retest Improvements"
Cohesion: 0.67
Nodes (4): AGENTS.md workspace instructions, Approval rule hygiene, .venv search exclusion, What Improved

### Community 112 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 113 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 114 - "Sidebar Tab Enum"
Cohesion: 0.67
Nodes (1): SidebarTab

### Community 115 - "Permissions Settings Tab"
Cohesion: 1.0
Nodes (2): render_permissions_tab(), tool_list_card()

### Community 116 - "Desktop Service Init"
Cohesion: 0.67
Nodes (1): InitializedServices

### Community 117 - "Progress Tracker"
Cohesion: 0.67
Nodes (3): Turn counting and loop detection, Stepwise orchestrator tool boundaries, Likely Root Causes

### Community 118 - "Turso Schema Migration"
Cohesion: 1.0
Nodes (0): 

### Community 119 - "Provider HTTP Client"
Cohesion: 1.0
Nodes (0): 

### Community 120 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 121 - "Brain Live Harness Test"
Cohesion: 1.0
Nodes (0): 

### Community 122 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 123 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 124 - "Keyboard Shortcuts Tab"
Cohesion: 1.0
Nodes (0): 

### Community 125 - "Icon Button"
Cohesion: 1.0
Nodes (0): 

### Community 126 - "Section Card"
Cohesion: 1.0
Nodes (0): 

### Community 127 - "Segmented Control"
Cohesion: 1.0
Nodes (0): 

### Community 128 - "Settings Row"
Cohesion: 1.0
Nodes (0): 

### Community 129 - "Markdown Style"
Cohesion: 1.0
Nodes (0): 

### Community 130 - "Nav Item"
Cohesion: 1.0
Nodes (0): 

### Community 131 - "Retest Validation Steps"
Cohesion: 1.0
Nodes (2): sessions.db sqlite store, Post-Run Validation

### Community 132 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **300 isolated node(s):** `LogChange`, `LogEntry`, `BootstrapReport`, `BootstrapSentinel`, `PageFrontmatter` (+295 more)
...
- **Should `Event Stream & Tokens` be split into smaller, more focused modules?**
  _Cohesion score 0.02 - nodes in this community are weakly interconnected._
- **Should `Live Provider Matrix` be split into smaller, more focused modules?**
