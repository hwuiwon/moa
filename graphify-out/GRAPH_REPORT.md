...
## Corpus Check
- Large corpus: 283 files · ~189,310 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 3212 nodes · 5754 edges · 105 communities detected
...
- `Stick-to-Bottom Scroll Behavior` --semantically_similar_to--> `Prompt-Kit Chat Container`  [INFERRED] [semantically similar]
  src/components/chat/message-list.tsx → src/components/prompt-kit/chat-container.tsx
- `Prompt-Kit Scroll Button` --semantically_similar_to--> `Stick-to-Bottom Scroll Behavior`  [INFERRED] [semantically similar]
  src/components/prompt-kit/scroll-button.tsx → src/components/chat/message-list.tsx
- `Virtualization Threshold (>100 messages)` --semantically_similar_to--> `Sidebar Virtualization Threshold (>50 sessions)`  [INFERRED] [semantically similar]
...
- `Session Status Color Coding` --semantically_similar_to--> `Workspace Risk Levels (low/moderate/high)`  [INFERRED] [semantically similar]
  src/components/layout/session-sidebar.tsx → src/components/chat/approval-card.tsx

## Hyperedges (group relationships)
- **Approval Gate Flow: ApprovalBlock → ApprovalCard → tauriClient.respondToApproval** — approval_card, concept_workspace_risk, concept_approval_decisions [INFERRED 0.87]
- **Tool Call Render Pipeline: ContentBlockRenderer → ToolGroup → Steps → Tool (prompt-kit)** — content_block_renderer, tool_group, pk_steps, pk_tool [EXTRACTED 0.95]
- **Streaming Assembly Flow: ChatView + useChatStream + MessageList + AssistantMessage** — chat_view, message_list, assistant_message, streaming_content [INFERRED 0.88]
...
Cohesion: 0.02
Nodes (48): Evaluator, build_provider_from_config(), build_provider_from_selection(), explicit_provider_prefix_overrides_inference(), infer_provider_name(), infers_anthropic_for_claude_models(), infers_openai_for_gpt_models(), infers_openrouter_for_vendor_prefixed_models() (+40 more)
...
### Community 7 - "Eval Loader Tests"
Cohesion: 0.05
Nodes (61): attach_runtime(), cancel_active_generation(), clone_runtime(), create_session(), delete_memory_page(), get_config(), get_runtime_info(), get_session() (+53 more)
...
### Community 14 - "Temporal Orchestrator"
Cohesion: 0.06
...
### Community 15 - "Local Orchestrator"
Cohesion: 0.07
...
### Community 16 - "Turso Session Store"
Cohesion: 0.07
...
### Community 17 - "OpenRouter Provider"
Cohesion: 0.07
Nodes (21): canonical_model_id(), capabilities_for_model(), gpt_5_4_family_reports_expected_capabilities(), native_tools(), native_web_search_tools(), OpenAIProvider, build_request_body(), canonical_model_id() (+13 more)
...
### Community 19 - "Chat UI Rendering Layer"
Cohesion: 0.04
Nodes (55): App Layout Shell, App Entry (App.tsx), Approval Card, Assistant Message, Chat View, Code Block (Chat), Approval Decision Types (allow_once/always_allow/deny), Command Palette Placeholder (Coming Next) (+47 more)

### Community 20 - "History Compilation Stage"
Cohesion: 0.08
...
### Community 21 - "Eval Execution Engine"
Cohesion: 0.08
...
### Community 22 - "Skill Regression Testing"
Cohesion: 0.07
...
### Community 25 - "Skill Injection Stage"
Cohesion: 0.08
...
### Community 26 - "Memory Consolidation"
Cohesion: 0.08
...
### Community 27 - "Brain Turn Execution"
Cohesion: 0.08
Nodes (39): append_event(), approval_decision_label(), buffer_queued_message(), drain_signal_queue(), emit_tool_output_warning(), execute_pending_tool(), execute_tool(), format_tool_output() (+31 more)

### Community 28 - "Chat View"
Cohesion: 0.08
Nodes (35): appendTextBlock(), approvalBlockFromEvent(), asBoolean(), asNumber(), asPayload(), asRecord(), asString(), eventsToMessages() (+27 more)
...
### Community 39 - "Provider Common Layer"
Cohesion: 0.12
Nodes (26): build_function_tool(), build_http_client(), build_responses_request(), consume_responses_stream_once(), is_ignorable_openai_stream_error(), is_rate_limit_error(), is_rate_limit_message(), map_openai_error() (+18 more)
...
### Community 47 - "Approval Card Widget"
Cohesion: 0.13
...
### Community 48 - "Session Store Tests"
Cohesion: 0.14
...
### Community 66 - "Memory Store Tests"
Cohesion: 0.36
...
### Community 67 - "Postgres Store Tests"
Cohesion: 0.36
...
### Community 70 - "Neon Branch Manager Tests"
Cohesion: 0.5
...
### Community 80 - "Sidebar Widget"
Cohesion: 0.5
Nodes (2): render_sidebar(), section_title()

### Community 81 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 
...
### Community 83 - "Tailwind Merge Util"
Cohesion: 0.5
Nodes (2): formatAbsoluteDate(), formatRelativeTime()

### Community 84 - "OpenRouter Live Test"
Cohesion: 0.83
...
### Community 85 - "Chat Harness Example"
Cohesion: 0.83
Nodes (3): main(), resolve_session_db_path(), run_prompt()

### Community 86 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 87 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 88 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 89 - "Frontend Toolchain Assets"
Cohesion: 0.67
Nodes (3): Tauri Logo SVG, Tauri + Vite Frontend Toolchain, Vite Logo SVG

### Community 90 - "TUI Workflow Tests"
Cohesion: 1.0
Nodes (0): 

### Community 91 - "Turso Schema Migration"
Cohesion: 1.0
Nodes (0): 

### Community 92 - "Tauri Build Entry"
Cohesion: 1.0
Nodes (0): 

### Community 93 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 94 - "Brain Live Harness Test"
Cohesion: 1.0
Nodes (0): 

### Community 95 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 
...
### Community 97 - "Vite Config"
Cohesion: 1.0
Nodes (0): 

### Community 98 - "TUI Runner"
Cohesion: 1.0
Nodes (0): 

### Community 99 - "Vite Env Types"
Cohesion: 1.0
Nodes (0): 

### Community 100 - "stores"
Cohesion: 1.0
Nodes (0): 

### Community 101 - "stores"
Cohesion: 1.0
Nodes (0): 

### Community 102 - "Prompt-Kit Loader"
Cohesion: 1.0
Nodes (1): Prompt-Kit Loader

### Community 103 - "Text Shimmer Animation"
Cohesion: 1.0
Nodes (1): Text Shimmer CSS Animation

### Community 104 - "Prompt-Kit Message"
Cohesion: 1.0
