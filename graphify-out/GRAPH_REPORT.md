...
## Corpus Check
- Large corpus: 371 files · ~308,242 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 5942 nodes · 10603 edges · 170 communities detected
...
10. `load_session_store()` - 23 edges
...
Cohesion: 0.01
Nodes (135): ChangelogRecord, validate_scope(), write_and_bump(), EdgeLabel, EdgeWriteIntent, Evaluator, LineageRecordId, TurnId (+127 more)
...
Cohesion: 0.02
Nodes (102): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), AgTypeParam, Cypher (+94 more)
...
Cohesion: 0.02
Nodes (52): approval_requested_event_round_trips_full_prompt(), Event, sample_approval_prompt(), discover_configs(), discover_matching_toml_files(), discover_suites(), discover_toml_files(), load_agent_config() (+44 more)
...
### Community 13 - "Postgres Session Store"
Cohesion: 0.05
...
### Community 15 - "Sub-Agent Dispatch"
Cohesion: 0.05
...
### Community 17 - "Privacy Export & Erase"
Cohesion: 0.06
...
### Community 22 - "Fast Ingestion Path"
Cohesion: 0.05
...
### Community 23 - "File Read & Write Tools"
Cohesion: 0.05
...
### Community 25 - "Lineage MPSC Sink Writer"
Cohesion: 0.05
...
### Community 26 - "Orchestrator Test Harness"
Cohesion: 0.05
...
### Community 35 - "Turn Streaming & Approvals"
Cohesion: 0.05
...
### Community 40 - "Workspace Instructions"
Cohesion: 0.07
...
### Community 41 - "Cache Observability"
Cohesion: 0.06
...
### Community 42 - "Daytona Sandbox Provider"
Cohesion: 0.08
...
### Community 43 - "Fact Extraction & SSE"
Cohesion: 0.06
...
### Community 46 - "Tool Result Store"
Cohesion: 0.06
...
### Community 48 - "Slow Ingestion Path"
Cohesion: 0.11
...
### Community 49 - "E2B Sandbox Provider"
Cohesion: 0.12
...
### Community 51 - "Lineage Records & Stages"
Cohesion: 0.05
...
### Community 52 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 53 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 54 - "MCP Client Discovery"
Cohesion: 0.11
...
### Community 63 - "Workspace Promotion"
Cohesion: 0.1
...
### Community 65 - "Live Ingestion E2E"
Cohesion: 0.14
...
### Community 66 - "Tool Router Policy"
Cohesion: 0.09
...
### Community 67 - "LLM Span Instrumentation"
Cohesion: 0.12
...
### Community 68 - "Intent Manager Service"
Cohesion: 0.09
...
### Community 69 - "Live Cache Audit Tests"
Cohesion: 0.13
...
### Community 70 - "MCP Credential Proxy"
Cohesion: 0.12
...
### Community 72 - "Encrypted Secret Vault"
Cohesion: 0.14
...
### Community 73 - "Live Observability Tests"
Cohesion: 0.11
...
### Community 74 - "Session DB Codecs"
Cohesion: 0.1
...
### Community 75 - "Local Tools Integration Tests"
Cohesion: 0.13
...
### Community 77 - "Citation Verifiers"
Cohesion: 0.13
...
### Community 81 - "Pgvector Store Tests"
Cohesion: 0.15
...
### Community 82 - "Scripted Test Provider"
Cohesion: 0.14
Nodes (3): ScriptedBlock, ScriptedProvider, ScriptedResponse

### Community 83 - "Runtime Context Stage"
Cohesion: 0.19
...
### Community 84 - "Session Analytics"
Cohesion: 0.15
...
### Community 91 - "Task Segment Tracker"
Cohesion: 0.14
...
### Community 96 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 97 - "Security Policies"
Cohesion: 0.23
...
### Community 109 - "Ingest Runtime Context"
Cohesion: 0.2
...
### Community 114 - "Cold Tier Exporter"
Cohesion: 0.27
...
### Community 117 - "Live Provider Roundtrip"
Cohesion: 0.38
...
### Community 118 - "Provider Model Catalog"
Cohesion: 0.29
...
### Community 119 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 120 - "Instruction Stage"
Cohesion: 0.38
...
### Community 124 - "Session VO Tests"
Cohesion: 0.5
...
### Community 137 - "Shell Chain Splitter"
Cohesion: 0.5
Nodes (2): push_sub_command(), split_shell_chain()

### Community 138 - "Scoped Transaction Lifecycle"
Cohesion: 0.5
Nodes (1): ScopedConn<'p>

### Community 139 - "Unified Diff"
Cohesion: 0.6
...
### Community 142 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 
...
### Community 146 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 147 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 148 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 149 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 150 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 151 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 152 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 153 - "Perf Gate Binary"
Cohesion: 0.67
Nodes (1): Args

### Community 154 - "Cold Tier Partition Tests"
Cohesion: 1.0
Nodes (0): 

### Community 155 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 156 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 157 - "Provider HTTP Client"
Cohesion: 1.0
Nodes (0): 

### Community 158 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0): 

### Community 159 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 160 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 161 - "Agent Adapter"
Cohesion: 1.0
Nodes (1): AgentAdapter

### Community 162 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 163 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 164 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 165 - "Perf Gate Config"
Cohesion: 1.0
Nodes (1): PerfGateConfig

### Community 166 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 167 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 168 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 169 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **600 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `IngestError`, `SessionTurn` (+595 more)
