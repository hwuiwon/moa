...
## Corpus Check
- Large corpus: 519 files · ~313,817 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6024 nodes · 9740 edges · 211 communities detected
...
Cohesion: 0.01
Nodes (169): PreparedTurnRequest, build_default_pipeline(), build_default_pipeline_with_tools(), GraphMemoryPipelineOptions, DatabaseConfig, DatabaseNeonConfig, GatewayConfig, CatalogIntent (+161 more)

### Community 1 - "PII Redaction Core"
Cohesion: 0.01
Nodes (122): ChangelogRecord, validate_scope(), write_and_bump(), IngestCtx, IngestRuntime, install_runtime(), install_runtime_with_pool(), OrchestratorCtx (+114 more)

### Community 2 - "Changelog Audit & RLS"
Cohesion: 0.02
Nodes (125): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), AgTypeParam, Cypher (+117 more)

### Community 3 - "CLI Entry Points"
Cohesion: 0.02
Nodes (115): AdminCommand, format_promotion_report(), handle_admin_command(), promote_workspace_e2e(), PromoteWorkspaceArgs, WorkspacePromotionArgs, BaseModel, CacheCommand (+107 more)
...
### Community 5 - "Local Orchestrator Tests"
Cohesion: 0.05
...
### Community 6 - "Audit Errors & Merkle Chain"
Cohesion: 0.02
Nodes (57): canonical_json_bytes(), canonical_payload_hash(), chain_detects_tampered_payload(), HashChain, next_chain_hash(), CacheBreakpoint, CacheBreakpointTarget, CacheTtl (+49 more)
...
Cohesion: 0.04
Nodes (48): append_skill_learning(), build_distillation_prompt(), count_tool_calls(), extract_task_summary(), find_similar_skill(), maybe_distill_skill(), maybe_distill_skill_with_learning(), normalize_new_skill() (+40 more)

### Community 10 - "Orchestrator Test Harness"
Cohesion: 0.04
Nodes (66): approval_allow_once_round_trip_through_restate(), configured_env(), live_model(), object_url(), register_deployment(), spawn_orchestrator(), wait_for_approval_request(), wait_for_brain_response_count() (+58 more)
...
### Community 12 - "File Read & Write Tools"
Cohesion: 0.04
...
### Community 13 - "Memory Scope Tool"
Cohesion: 0.03
...
### Community 14 - "Cache Observability"
Cohesion: 0.04
Nodes (44): add_session_trace_link(), apply_session_trace(), CacheReport, fingerprint_json(), full_request_fingerprint(), generate_trace_tags(), normalize_environment(), sanitize_langfuse_id() (+36 more)

### Community 15 - "Embedding Provider"
Cohesion: 0.04
Nodes (41): daemon_info(), decode_stream_chunk(), expect_success(), expect_success_json(), extract_exit_code(), http_error(), parse_e2b_connect_stream(), request() (+33 more)

### Community 16 - "Hybrid Retriever"
Cohesion: 0.04
...
### Community 17 - "Fast Ingestion Path"
Cohesion: 0.05
...
### Community 18 - "Lineage MPSC Sink Writer"
Cohesion: 0.05
...
### Community 19 - "Session Replay Snapshots"
Cohesion: 0.05
...
### Community 20 - "Provider Streaming"
Cohesion: 0.05
Nodes (36): GeminiCachedContent, GeminiCandidate, GeminiContent, GeminiFunctionCall, GeminiGenerateContentResponse, GeminiPart, GeminiUsageMetadata, ResponsesStreamError (+28 more)

### Community 21 - "Eval Engine & Plan"
Cohesion: 0.06
Nodes (36): CollectedExecution, collector_tracks_tool_steps_and_metrics(), estimate_cost(), TrajectoryCollector, truncate(), build_error_result(), cleanup_workspace(), dry_run_marks_results_skipped() (+28 more)

### Community 22 - "LLM Gateway Service"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (54): Args, begin_audited_read(), collect_changelog(), collect_embeddings(), collect_entities(), collect_facts(), collect_nodes(), collect_relationships() (+46 more)

### Community 25 - "Contradiction Detection"
Cohesion: 0.06
...
### Community 26 - "Cross-Tenant Pentest Suite"
Cohesion: 0.08
...
### Community 27 - "Skill Tier1 Metadata"
Cohesion: 0.06
...
### Community 29 - "Golden E2E Fixtures"
Cohesion: 0.07
...
### Community 31 - "Tool Executor Service"
Cohesion: 0.08
...
### Community 33 - "Query Planner & NER"
Cohesion: 0.07
...
### Community 34 - "Telemetry Init"
Cohesion: 0.06
Nodes (29): from_reader_requires_postgres_url(), from_reader_uses_defaults_and_optional_values(), linux_memory_gb(), OrchestratorConfig, parse_otlp_headers(), parse_otlp_protocol(), to_moa_config_applies_local_overrides(), validate_hardware_floor() (+21 more)

### Community 35 - "History Compilation"
Cohesion: 0.05
...
### Community 36 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 37 - "Fact Extraction & Chunking"
Cohesion: 0.07
Nodes (36): ApiState, build_api_router(), health_endpoint_returns_ok(), runtime_event_stream(), session_stream(), session_stream_emits_gap_event_when_runtime_subscriber_lags(), session_stream_returns_not_found_when_runtime_is_unavailable(), session_stream_returns_sse_content_type() (+28 more)

### Community 38 - "Tool Result Store"
Cohesion: 0.06
...
### Community 40 - "Provider Selection & Routing"
Cohesion: 0.08
...
### Community 41 - "Object State Management"
Cohesion: 0.08
...
### Community 44 - "Gateway Message Renderer"
Cohesion: 0.09
...
### Community 45 - "Lineage Records & Stages"
Cohesion: 0.05
...
### Community 46 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 47 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 48 - "Provider Request Builders"
Cohesion: 0.09
Nodes (28): annotate_cache_control(), annotate_message_cache_control(), anthropic_output_config(), anthropic_text_block(), apply_cache_breakpoints(), build_cache_create_body(), build_completion_request(), build_contents_from_messages() (+20 more)

### Community 49 - "Approval Request Types"
Cohesion: 0.08
...
### Community 52 - "Pgvector Store Tests"
Cohesion: 0.11
Nodes (19): backfill_from(), listen_stream_backfills_from_last_seen_sequence(), listen_stream_receives_cross_store_events_in_order(), NotifyPayload, rolled_back_notify_is_not_observed(), run_listener_task(), seed_session(), session_channel_name() (+11 more)

### Community 53 - "Slack Adapter"
Cohesion: 0.13
...
### Community 54 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 55 - "Session Types"
Cohesion: 0.07
Nodes (22): BufferedUserMessage, CancelMode, CheckpointHandle, CheckpointInfo, DaemonConfig, ObserveLevel, pending_signal_queue_message_round_trip(), PendingSignal (+14 more)

### Community 56 - "Gemini Embedder"
Cohesion: 0.08
...
### Community 57 - "Workspace Promotion"
Cohesion: 0.1
...
### Community 58 - "Citation Provider Adapters"
Cohesion: 0.12
...
### Community 60 - "Skill Regression Suite"
Cohesion: 0.11
Nodes (25): append_skill_regression_log(), build_generated_suite(), compare_scores(), default_skill_evaluators(), estimate_suite_cost(), estimate_tokens(), execute_skill_suite(), expand_local_path() (+17 more)

### Community 61 - "Session Event Store"
Cohesion: 0.07
...
### Community 66 - "Live Observability Tests"
Cohesion: 0.11
...
### Community 67 - "Encrypted Secret Vault"
Cohesion: 0.14
...
### Community 68 - "Session Analytics"
Cohesion: 0.11
...
### Community 69 - "Skills CLI Command"
Cohesion: 0.14
Nodes (23): bootstrap_global_skills(), cli_export_import_round_trips_skill_body(), current_workspace_id(), discover_skill_files(), export_skills(), graph_store(), handle_skills_command(), import_skills() (+15 more)
...
### Community 71 - "Citation Verifiers"
Cohesion: 0.13
...
### Community 72 - "Query Rewrite Postprocess"
Cohesion: 0.11
...
### Community 73 - "Eval Environment Setup"
Cohesion: 0.14
Nodes (20): AgentEnvironment, build_agent_environment(), build_agent_environment_with_provider(), build_eval_policies(), build_pipeline(), build_tool_router(), compose_identity_prompt(), configured_default_memory_root() (+12 more)

### Community 74 - "Vector Store Backend"
Cohesion: 0.13
...
### Community 75 - "Session Message Helpers"
Cohesion: 0.17
...
### Community 76 - "Session Blob Store"
Cohesion: 0.18
...
### Community 77 - "Task Segment Tracker"
Cohesion: 0.12
...
### Community 83 - "Local Orchestrator Wiring"
Cohesion: 0.15
Nodes (1): LocalOrchestrator

### Community 84 - "Scripted Provider"
Cohesion: 0.14
Nodes (3): ScriptedBlock, ScriptedProvider, ScriptedResponse

### Community 85 - "Orchestrator Contract Harness"
Cohesion: 0.22
...
### Community 86 - "Session Postgres Store Tests"
Cohesion: 0.23
...
### Community 87 - "Postgres Session Store"
Cohesion: 0.19
Nodes (1): PostgresSessionStore

### Community 88 - "Session Store Handlers"
Cohesion: 0.1
Nodes (1): SessionStoreImpl

### Community 89 - "Grep Tool"
Cohesion: 0.17
...
### Community 90 - "Tool Router Construction"
Cohesion: 0.13
Nodes (2): default_cloud_provider(), ToolRouter

### Community 91 - "Approval Token Auth"
Cohesion: 0.15
...
### Community 92 - "Session Store Inner Impl"
Cohesion: 0.11
Nodes (1): SessionStoreImpl

### Community 93 - "Conversation Compaction"
Cohesion: 0.17
...
### Community 94 - "Tenant Intent Store"
Cohesion: 0.12
Nodes (1): PostgresSessionStore

### Community 95 - "Live Provider Matrix"
Cohesion: 0.25
...
### Community 96 - "Brain Integration E2E"
Cohesion: 0.19
...
### Community 99 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 100 - "Security Policies"
Cohesion: 0.23
...
### Community 101 - "Retrieval Load Scenario"
Cohesion: 0.2
...
### Community 102 - "Tool Output Budget"
Cohesion: 0.24
...
### Community 109 - "Cross-Tenant Isolation Loadtest"
Cohesion: 0.21
...
### Community 110 - "Resolution Scorer"
Cohesion: 0.25
...
### Community 111 - "Segment Store"
Cohesion: 0.16
Nodes (1): PostgresSessionStore

### Community 112 - "Provider Retry Policy"
Cohesion: 0.27
...
### Community 113 - "Tool Outcome Signal"
Cohesion: 0.2
Nodes (8): all_tools_failed(), brain_response(), record(), score(), tool_call(), tool_outcomes(), tool_result(), ToolOutcome

### Community 114 - "Loadtest Reporting"
Cohesion: 0.19
...
### Community 115 - "Prometheus Metrics Tests"
Cohesion: 0.23
...
### Community 116 - "Gemini Provider"
Cohesion: 0.26
Nodes (1): GeminiProvider

### Community 117 - "Query Planner Tests"
Cohesion: 0.15
Nodes (1): SeedGraph

### Community 118 - "Per-Session Scripted Provider"
Cohesion: 0.24
Nodes (7): auxiliary_scripted_response(), completion_stream_from_scripted_response(), mock_skill_markdown(), PerSessionScriptedProvider, scripted_capabilities(), scripted_responses_for_plan(), scripted_text_response()

### Community 119 - "AGE Graph Store"
Cohesion: 0.18
Nodes (1): AgeGraphStore

### Community 120 - "Sandbox Config"
Cohesion: 0.18
Nodes (7): CloudConfig, CloudFlyioConfig, CloudHandsConfig, LocalConfig, McpCredentialConfig, McpServerConfig, McpTransportConfig

### Community 121 - "Privacy Erase Command"
Cohesion: 0.29
...
### Community 131 - "Turn Loop Detector"
Cohesion: 0.33
...
### Community 132 - "Intent Classifier"
Cohesion: 0.33
...
### Community 135 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 138 - "Rewrite & Compaction Triggers"
Cohesion: 0.24
Nodes (5): approximate_query_tokens(), QueryRewriter, should_apply_tier2(), starts_with_tool_like_verb(), token_count()

### Community 139 - "Deterministic Compactor"
Cohesion: 0.36
Nodes (9): apply_tier1(), apply_tier2(), compacted_tool_result(), is_compacted_tool_result(), is_file_read_result_message(), referenced_tool_use_ids(), tier1_is_idempotent_for_compacted_messages(), tier2_replaces_old_history_with_placeholder() (+1 more)

### Community 140 - "Sub-Agent Handlers"
Cohesion: 0.22
Nodes (2): maybe_resolve_parent_awakeable(), SubAgentImpl

### Community 141 - "Bash Tool"
Cohesion: 0.39
...
### Community 142 - "Identity Stage"
Cohesion: 0.44
Nodes (3): identity_processor_appends_system_prompt(), identity_prompt_includes_coding_guardrails(), IdentityProcessor

### Community 143 - "Rewrite Input Builder"
Cohesion: 0.31
Nodes (5): input_from_context_messages(), input_from_conversation(), input_from_event_records(), QueryRewriter, RewriteInput

### Community 144 - "Rewrite Circuit Breaker"
Cohesion: 0.47
Nodes (2): CircuitBreaker, now_epoch_millis()

### Community 145 - "Resolution Score Types"
Cohesion: 0.29
Nodes (5): ResolutionLabel, ResolutionScore, ScoringPhase, SegmentBaseline, SkillResolutionRate

### Community 146 - "Moa Config Loader"
Cohesion: 0.46
Nodes (1): MoaConfig

### Community 147 - "Brain Orchestrator API"
Cohesion: 0.25
Nodes (1): LocalOrchestrator

### Community 148 - "Daemon Server"
Cohesion: 0.46
...
### Community 149 - "Session VO Tests"
Cohesion: 0.5
...
### Community 150 - "Session Object Handlers"
Cohesion: 0.29
Nodes (1): SessionImpl

### Community 151 - "Health Service"
Cohesion: 0.32
Nodes (4): Health, HealthImpl, version_info_reports_expected_versions(), VersionInfo

### Community 152 - "Self Assessment Signal"
Cohesion: 0.29
Nodes (2): contains_any(), score()

### Community 153 - "Structural Signal"
Cohesion: 0.32
Nodes (5): baseline(), cold_start_returns_none(), is_high_outlier(), score(), SegmentMetrics

### Community 154 - "Lexical Seed Store"
Cohesion: 0.43
Nodes (2): LexicalStore, lookup_seed_rows()

### Community 155 - "Lineage Fjall Journal"
Cohesion: 0.29
Nodes (1): Journal

### Community 156 - "Daemon Protocol"
Cohesion: 0.52
...
### Community 157 - "Daemon Paths"
Cohesion: 0.48
Nodes (5): daemon_log_path(), daemon_pid_path(), daemon_socket_path(), expand_path(), read_pid_file()

### Community 158 - "Query Rewrite Live Tests"
Cohesion: 0.38
Nodes (2): CapturingProvider, live_query_rewriter_resolves_coreference_without_new_entities()

### Community 159 - "Trajectory Match Evaluator"
Cohesion: 0.43
Nodes (4): exact_match_scores_one(), lcs_len(), partial_match_scores_below_one(), TrajectoryMatchEvaluator

### Community 160 - "Output Match Evaluator"
Cohesion: 0.43
...
### Community 161 - "Live E2E Fixtures"
Cohesion: 0.43
...
### Community 172 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 

### Community 173 - "Cohere Live Test"
Cohesion: 0.83
Nodes (3): cohere_embed_v4_returns_1024_dimensional_float_embeddings(), live_cohere_key(), live_cohere_requested()

### Community 174 - "Turbopuffer Live Tests"
Cohesion: 0.83
Nodes (3): basis_vector(), live_store(), turbopuffer_live_round_trip()

### Community 175 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn

### Community 176 - "Approval Rule Store"
Cohesion: 0.5
Nodes (1): PostgresSessionStore

### Community 177 - "Cohere Reranker Live Test"
Cohesion: 0.83
Nodes (3): cohere_rerank_v4_fast_prioritizes_relevant_retrieval_candidate(), live_cohere_key(), live_cohere_requested()

### Community 178 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 179 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 180 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 181 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 182 - "Session Store Helpers"
Cohesion: 0.67
Nodes (1): PostgresSessionStore

### Community 183 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 184 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 185 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 186 - "Perf Gate Binary"
Cohesion: 0.67
Nodes (1): Args

### Community 187 - "Vector Error Mapping"
Cohesion: 1.0
Nodes (1): moa_core::MoaError

### Community 188 - "Cold Tier Partition Tests"
Cohesion: 1.0
Nodes (0): 

### Community 189 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 190 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 191 - "Session Task Runner"
Cohesion: 1.0
Nodes (0): 

### Community 192 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0): 

### Community 193 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 194 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 195 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 196 - "History Budgeting"
Cohesion: 1.0
Nodes (0): 

### Community 197 - "History Error Preservation"
Cohesion: 1.0
Nodes (0): 

### Community 198 - "History Compaction Compile"
Cohesion: 1.0
Nodes (1): HistoryCompiler

### Community 199 - "Skills Cache Break"
Cohesion: 1.0
Nodes (0): 

### Community 200 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 201 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 202 - "Perf Gate Config"
Cohesion: 1.0
Nodes (1): PerfGateConfig

### Community 203 - "Workspace Hack Build"
Cohesion: 1.0
Nodes (0): 

### Community 204 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 205 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 206 - "Brain Orchestrator Stub"
Cohesion: 1.0
Nodes (0): 
...
### Community 208 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 209 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 

### Community 210 - "Session Store Inner"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **611 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `IngestError`, `SessionTurn` (+606 more)
...
- **Should `PII Redaction Core` be split into smaller, more focused modules?**
  _Cohesion score 0.01 - nodes in this community are weakly interconnected._
- **Should `Changelog Audit & RLS` be split into smaller, more focused modules?**
