...
## Corpus Check
- Large corpus: 540 files · ~324,714 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6267 nodes · 10192 edges · 214 communities detected
...
Cohesion: 0.01
Nodes (186): PreparedTurnRequest, build_default_pipeline(), build_default_pipeline_with_tools(), GraphMemoryPipelineOptions, DatabaseConfig, DatabaseNeonConfig, Args, begin_app_scoped_tx() (+178 more)

### Community 1 - "PII Redaction Core"
Cohesion: 0.01
Nodes (113): ChangelogRecord, validate_scope(), write_and_bump(), IngestCtx, IngestRuntime, install_runtime(), install_runtime_with_pool(), OrchestratorCtx (+105 more)

### Community 2 - "Changelog Audit & RLS"
Cohesion: 0.02
Nodes (113): changelog_rejects_updates_for_app_role(), changelog_write_bumps_workspace_version_and_respects_read_rls(), record(), set_app_role(), set_auditor_role(), set_workspace_gucs(), AgTypeParam, Cypher (+105 more)

### Community 3 - "Orchestrator Test Harness"
Cohesion: 0.03
Nodes (104): approval_allow_once_round_trip_through_restate(), configured_env(), live_model(), object_url(), register_deployment(), spawn_orchestrator(), wait_for_approval_request(), wait_for_brain_response_count() (+96 more)

### Community 4 - "CLI Command Tests"
Cohesion: 0.02
Nodes (69): collect_session_tool_observations(), merge_session_observation(), normalize_error_pattern(), record_error_pattern(), SessionToolObservation, top_error_patterns(), truncate_with_ellipsis(), workspace_tool_stats_from_events() (+61 more)

### Community 5 - "CLI Entry Points"
Cohesion: 0.02
...
Cohesion: 0.03
Nodes (73): append_skill_learning(), build_distillation_prompt(), count_tool_calls(), extract_task_summary(), find_similar_skill(), maybe_distill_skill(), maybe_distill_skill_with_learning(), normalize_new_skill() (+65 more)

### Community 7 - "Audit Errors & Merkle Chain"
Cohesion: 0.02
Nodes (73): AdapterError, answer_span_bytes(), anthropic_adapter_maps_document_index(), anthropic_chunk(), AnthropicCitations, cascade_flags_vendor_hallucinated_citation(), ChunkRef, chunks() (+65 more)
...
### Community 13 - "File Read & Write Tools"
Cohesion: 0.04
...
### Community 14 - "Memory Scope Tool"
Cohesion: 0.03
...
### Community 16 - "Fast Ingestion Path"
Cohesion: 0.05
...
### Community 17 - "Lineage MPSC Sink Writer"
Cohesion: 0.05
...
### Community 18 - "Session Replay Snapshots"
Cohesion: 0.05
...
### Community 21 - "Intent Discovery Workflow"
Cohesion: 0.05
...
### Community 26 - "LLM Gateway Service"
Cohesion: 0.06
...
### Community 28 - "Graph Write & Export"
Cohesion: 0.07
...
### Community 30 - "Cross-Tenant Pentest Suite"
Cohesion: 0.08
...
### Community 31 - "Skill Tier1 Metadata"
Cohesion: 0.06
...
### Community 33 - "Golden E2E Fixtures"
Cohesion: 0.07
...
### Community 34 - "Cache Observability"
Cohesion: 0.06
...
### Community 35 - "Query Planner & NER"
Cohesion: 0.07
...
### Community 36 - "Turn & Tool Dispatch"
Cohesion: 0.05
...
### Community 37 - "History Compilation"
Cohesion: 0.05
...
### Community 38 - "Neon Branch Manager"
Cohesion: 0.09
...
### Community 39 - "Fact Extraction & Chunking"
Cohesion: 0.07
...
### Community 40 - "Tool Result Store"
Cohesion: 0.06
...
### Community 42 - "Provider Selection & Routing"
Cohesion: 0.08
...
### Community 43 - "Object State Management"
Cohesion: 0.08
...
### Community 44 - "Agent Adapter"
Cohesion: 0.06
Nodes (3): AgentAdapter, SessionTurnAdapter, SubAgentTurnAdapter

### Community 45 - "Approval Always-Allow Tests"
Cohesion: 0.15
...
### Community 48 - "Gateway Message Renderer"
Cohesion: 0.09
...
### Community 49 - "Lineage Records & Stages"
Cohesion: 0.05
...
### Community 50 - "Turbopuffer Vector Store"
Cohesion: 0.12
...
### Community 51 - "Broadcast Lag Handling"
Cohesion: 0.07
...
### Community 53 - "Provider Request Builders"
Cohesion: 0.09
...
### Community 54 - "Completion Content Types"
Cohesion: 0.07
...
### Community 58 - "Turn Latency Counters"
Cohesion: 0.11
...
### Community 59 - "Workspace Promotion"
Cohesion: 0.1
...
### Community 62 - "Concurrent Event Monotonicity Tests"
Cohesion: 0.12
Nodes (22): configured_test_db(), delete_on_events_is_blocked_for_app_role(), migration_applied_idempotently_does_not_break_invariant(), seeded_event(), truncate_on_events_is_blocked_for_app_role(), update_on_events_is_blocked_even_if_privilege_is_regranted(), update_on_events_is_blocked_for_app_role(), assert_dense_sequences() (+14 more)
...
### Community 68 - "Live Observability Tests"
Cohesion: 0.11
...
### Community 70 - "Session Analytics"
Cohesion: 0.11
...
### Community 71 - "Skills CLI Command"
Cohesion: 0.14
...
### Community 73 - "Citation Verifiers"
Cohesion: 0.13
...
### Community 74 - "Query Rewrite Postprocess"
Cohesion: 0.11
...
### Community 75 - "Eval Environment Setup"
Cohesion: 0.14
...
### Community 76 - "Vector Store Backend"
Cohesion: 0.13
...
### Community 77 - "Orchestrator Contract Harness"
Cohesion: 0.17
...
### Community 78 - "Session Message Helpers"
Cohesion: 0.17
...
### Community 79 - "Session Blob Store"
Cohesion: 0.18
...
### Community 80 - "Local Hand Provider"
Cohesion: 0.16
Nodes (3): detect_docker(), docker_status(), LocalHandProvider

### Community 81 - "Task Segment Tracker"
Cohesion: 0.12
...
### Community 82 - "Pgvector Store Tests"
Cohesion: 0.15
...
### Community 91 - "Session Store Handlers"
Cohesion: 0.1
Nodes (1): SessionStoreImpl

### Community 92 - "Grep Tool"
Cohesion: 0.17
...
### Community 93 - "Tool Router Construction"
Cohesion: 0.13
Nodes (2): default_cloud_provider(), ToolRouter

### Community 94 - "Approval Token Auth"
Cohesion: 0.15
...
### Community 97 - "Tenant Intent Store"
Cohesion: 0.12
Nodes (1): PostgresSessionStore

### Community 98 - "Live Provider Matrix"
Cohesion: 0.25
...
### Community 99 - "Brain Integration E2E"
Cohesion: 0.19
...
### Community 100 - "Audit Signing Keys"
Cohesion: 0.2
Nodes (6): deterministic_seed(), load_or_create_seed(), LocalSigningKeyVault, signing_roundtrip_rejects_tampering(), SigningKey, SigningKeyVault

### Community 101 - "CLI Exec Command"
Cohesion: 0.15
...
### Community 102 - "Session DB Enum Mapping"
Cohesion: 0.12
Nodes (0): 

### Community 103 - "OpenAI Provider Tests"
Cohesion: 0.22
...
### Community 104 - "Security Policies"
Cohesion: 0.23
...
### Community 105 - "Retrieval Load Scenario"
Cohesion: 0.2
...
### Community 106 - "Tool Output Budget"
Cohesion: 0.24
...
### Community 107 - "Mock Smoke Loadtest"
Cohesion: 0.2
...
### Community 112 - "Cross-Tenant Isolation Loadtest"
Cohesion: 0.21
...
### Community 113 - "Segment Store"
Cohesion: 0.16
Nodes (1): PostgresSessionStore

### Community 114 - "Provider Retry Policy"
Cohesion: 0.27
...
### Community 115 - "Resolution Scorer"
Cohesion: 0.25
...
### Community 116 - "Loadtest Reporting"
Cohesion: 0.19
...
### Community 117 - "Prometheus Metrics Tests"
Cohesion: 0.23
...
### Community 123 - "Anthropic Provider"
Cohesion: 0.26
Nodes (1): AnthropicProvider

### Community 124 - "Segment Scoring"
Cohesion: 0.38
...
### Community 133 - "Turn Loop Detector"
Cohesion: 0.33
...
### Community 134 - "Intent Classifier"
Cohesion: 0.33
...
### Community 135 - "Live Provider Roundtrip"
Cohesion: 0.38
...
### Community 136 - "Tool Approval Store"
Cohesion: 0.22
...
### Community 139 - "Rewrite & Compaction Triggers"
Cohesion: 0.24
...
### Community 149 - "Provider Request Body Snapshots"
Cohesion: 0.43
...
### Community 150 - "Session VO Tests"
Cohesion: 0.5
...
### Community 151 - "Session Object Handlers"
Cohesion: 0.29
Nodes (1): SessionImpl

### Community 152 - "Health Service"
Cohesion: 0.32
Nodes (4): Health, HealthImpl, version_info_reports_expected_versions(), VersionInfo

### Community 153 - "Self Assessment Signal"
Cohesion: 0.29
Nodes (2): contains_any(), score()

### Community 154 - "Structural Signal"
Cohesion: 0.32
Nodes (5): baseline(), cold_start_returns_none(), is_high_outlier(), score(), SegmentMetrics

### Community 155 - "Lexical Seed Store"
Cohesion: 0.43
Nodes (2): LexicalStore, lookup_seed_rows()

### Community 156 - "Lineage Fjall Journal"
Cohesion: 0.29
Nodes (1): Journal

### Community 157 - "Daemon Protocol"
Cohesion: 0.52
...
### Community 167 - "Perf Gate Binary"
Cohesion: 0.47
Nodes (3): Args, main(), Profile

### Community 168 - "Shell Chain Splitter"
Cohesion: 0.5
Nodes (2): push_sub_command(), split_shell_chain()

### Community 169 - "Scoped Transaction Lifecycle"
Cohesion: 0.5
Nodes (1): ScopedConn<'p>

### Community 170 - "Unified Diff"
Cohesion: 0.6
...
### Community 172 - "Gemini Live Tests"
Cohesion: 0.6
...
### Community 173 - "Anthropic Provider Tests"
Cohesion: 0.4
Nodes (0): 

### Community 174 - "Fake Clock Test Helper"
Cohesion: 0.4
Nodes (1): FakeClock

### Community 175 - "Cohere Live Test"
Cohesion: 0.83
Nodes (3): cohere_embed_v4_returns_1024_dimensional_float_embeddings(), live_cohere_key(), live_cohere_requested()

### Community 176 - "Turbopuffer Live Tests"
Cohesion: 0.83
Nodes (3): basis_vector(), live_store(), turbopuffer_live_round_trip()

### Community 177 - "DB Error Mapping"
Cohesion: 0.5
Nodes (1): ScopedConn

### Community 178 - "Approval Rule Store"
Cohesion: 0.5
Nodes (1): PostgresSessionStore

### Community 179 - "Cohere Reranker Live Test"
Cohesion: 0.83
Nodes (3): cohere_rerank_v4_fast_prioritizes_relevant_retrieval_candidate(), live_cohere_key(), live_cohere_requested()

### Community 180 - "Cost Budget Enforcement"
Cohesion: 0.67
Nodes (2): enforce_workspace_budget(), format_budget_exhausted_message()

### Community 181 - "Tool Success Evaluator"
Cohesion: 0.5
Nodes (1): ToolSuccessEvaluator

### Community 182 - "PII Live Sidecar Test"
Cohesion: 1.0
Nodes (2): live_service_url(), live_sidecar_classifies_private_and_clean_text()

### Community 183 - "Mock PII Classifier"
Cohesion: 0.67
Nodes (1): MockClassifier

### Community 184 - "Permissions Config"
Cohesion: 0.67
Nodes (1): PermissionsConfig

### Community 185 - "Gateway Config"
Cohesion: 0.67
Nodes (1): GatewayConfig

### Community 186 - "Session Store Helpers"
Cohesion: 0.67
Nodes (1): PostgresSessionStore

### Community 187 - "OpenAI Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 188 - "Anthropic Live Test"
Cohesion: 0.67
Nodes (0): 

### Community 189 - "Chat Harness Example"
Cohesion: 1.0
Nodes (2): main(), run_prompt()

### Community 190 - "Vector Error Mapping"
Cohesion: 1.0
Nodes (1): moa_core::MoaError

### Community 191 - "Cold Tier Partition Tests"
Cohesion: 1.0
Nodes (0): 

### Community 192 - "Model Identifier"
Cohesion: 1.0
Nodes (1): ModelId

### Community 193 - "Tool Call Identifier"
Cohesion: 1.0
Nodes (1): ToolCallId

### Community 194 - "Session Task Runner"
Cohesion: 1.0
Nodes (0): 

### Community 195 - "Shell Chaining Security Test"
Cohesion: 1.0
Nodes (0): 

### Community 196 - "Session Engine Gating"
Cohesion: 1.0
Nodes (0): 

### Community 197 - "Object Context"
Cohesion: 1.0
Nodes (1): ObjectContext<'a>

### Community 198 - "Shared Object Context"
Cohesion: 1.0
Nodes (1): SharedObjectContext<'a>

### Community 199 - "Docker Hardening Test"
Cohesion: 1.0
Nodes (0): 

### Community 200 - "History Budgeting"
Cohesion: 1.0
Nodes (0): 

### Community 201 - "History Error Preservation"
Cohesion: 1.0
Nodes (0): 

### Community 202 - "History Compaction Compile"
Cohesion: 1.0
Nodes (1): HistoryCompiler

### Community 203 - "Skills Cache Break"
Cohesion: 1.0
Nodes (0): 

### Community 204 - "Eval Live Tests"
Cohesion: 1.0
Nodes (0): 

### Community 205 - "Chat Runtime Trait"
Cohesion: 1.0
Nodes (1): ChatRuntime

### Community 206 - "Workspace Hack Build"
Cohesion: 1.0
Nodes (0): 

### Community 207 - "Skills Bootstrap Script"
Cohesion: 1.0
Nodes (0): 

### Community 208 - "Core Type Macros"
Cohesion: 1.0
Nodes (0): 

### Community 209 - "Brain Orchestrator Stub"
Cohesion: 1.0
Nodes (0): 

### Community 210 - "Local Orchestrator Stub"
Cohesion: 1.0
Nodes (0): 

### Community 211 - "Integration Test Entry"
Cohesion: 1.0
Nodes (0): 

### Community 212 - "Restate Registration"
Cohesion: 1.0
Nodes (0): 

### Community 213 - "Session Store Inner"
Cohesion: 1.0
Nodes (0): 

## Knowledge Gaps
- **621 isolated node(s):** `PiiSpan`, `PiiClassifier`, `PiiError`, `IngestError`, `SessionTurn` (+616 more)
...
- **Should `Orchestrator Test Harness` be split into smaller, more focused modules?**
